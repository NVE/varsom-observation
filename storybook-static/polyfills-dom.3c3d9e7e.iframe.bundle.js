/*! For license information please see polyfills-dom.3c3d9e7e.iframe.bundle.js.LICENSE.txt */
(window.webpackJsonp = window.webpackJsonp || []).push([
  [7],
  {
    './dist/esm/polyfills/dom.js': function (module, exports, __webpack_require__) {
      var b, c, d, a, e;
        ...
        function () {
            ...
            for (var c = a; c; ) {
              if (c.nodeType === Node.ELEMENT_NODE) {
                ...
                if ('link' === f && 'import' === e.getAttribute('rel')) {
                  if ((c = e.import) instanceof Node && !d.has(c)) for (d.add(c), c = c.firstChild; c; c = c.nextSibling) p(c, b, d);
                  c = n(a, e);
                  continue;
                }
                if ('template' === f) {
          ...
          function y(a, b) {
            if (void 0 === b.__CE_state) {
              ...
              if ((d.defaultView || (d.__CE_isImportDocument && d.__CE_hasRegistry)) && (d = a.a.get(b.localName))) {
                ...
                if (((b.__CE_state = 1), (b.__CE_definition = d), d.attributeChangedCallback))
          ...
          (u.prototype.connectedCallback = function (a) {
            ...
            (B.prototype.f = function (a) {
              ...
              for (('interactive' !== b && 'complete' !== b) || C(this), b = 0; b < a.length; b++) for (var d = a[b].addedNodes, c = 0; c < d.length; c++) A(this.c, d[c]);
            }),
            ...
            function c(b) {
              return function (d) {
                ...
                for (var f = [], m = 0; m < e.length; m++) {
                  var q = e[m];
                  if ((q instanceof Element && l(q) && f.push(q), q instanceof DocumentFragment)) for (q = q.firstChild; q; q = q.nextSibling) c.push(q);
                  else c.push(q);
                }
                for (b.apply(this, e), e = 0; e < f.length; e++) z(a, f[e]);
                if (l(this)) for (e = 0; e < c.length; e++) (f = c[e]) instanceof Element && x(a, f);
              };
            }
            ...
            !(function xa() {
              ...
              window.HTMLElement = (function () {
                function b() {
                  ...
                  return (e[c] = wa), Object.setPrototypeOf(f, b.prototype), w(a, f), f;
                }
                return (b.prototype = ta.prototype), Object.defineProperty(b.prototype, 'constructor', { writable: !0, configurable: !0, enumerable: !1, value: b }), b;
              })();
            })(),
              (function ya() {
                var a = X;
                r(Document.prototype, 'createElement', function (b) {
                  ...
                  r(Document.prototype, 'importNode', function (b, d) {
                    return (b = ha.call(this, b, !!d)), this.__CE_hasRegistry ? A(a, b) : v(a, b), b;
                  }),
              ...
              (function za() {
                  ...
                  Object.defineProperty(a, 'textContent', {
                    ...
                    set: function set(a) {
                      if (this.nodeType === Node.TEXT_NODE) c.set.call(this, a);
                        ...
                        if ((c.set.call(this, a), d)) for (a = 0; a < d.length; a++) z(b, d[a]);
                      }
                    },
                  });
                }
                ...
                r(Node.prototype, 'insertBefore', function (a, c) {
                  if (a instanceof DocumentFragment) {
                    ...
                    if (((a = J.call(this, a, c)), l(this))) for (c = 0; c < e.length; c++) x(b, e[c]);
                    return a;
                  }
                  return (e = l(a)), (c = J.call(this, a, c)), e && z(b, a), l(this) && x(b, a), c;
                }),
                  r(Node.prototype, 'appendChild', function (a) {
                    if (a instanceof DocumentFragment) {
                      var c = Array.prototype.slice.apply(a.childNodes);
                      if (((a = I.call(this, a)), l(this))) for (var e = 0; e < c.length; e++) x(b, c[e]);
                      return a;
                    }
                    return (c = l(a)), (e = I.call(this, a)), c && z(b, a), l(this) && x(b, a), e;
                  }),
                  r(Node.prototype, 'cloneNode', function (a) {
                    return (a = H.call(this, !!a)), this.ownerDocument.__CE_hasRegistry ? A(b, a) : v(b, a), a;
                  }),
                  ...
                  r(Node.prototype, 'replaceChild', function (a, c) {
                    if (a instanceof DocumentFragment) {
                      var e = Array.prototype.slice.apply(a.childNodes);
                      if (((a = L.call(this, a, c)), l(this))) for (z(b, c), c = 0; c < e.length; c++) x(b, e[c]);
                      return a;
                    }
                    e = l(a);
              ...
              (function Ba() {
                function a(a, b) {
                  Object.defineProperty(a, 'innerHTML', {
                    ...
                    set: function set(a) {
                      ...
                      return this.ownerDocument.__CE_hasRegistry ? A(c, this) : v(c, this), a;
                    },
                  });
                }
                function b(a, b) {
                  r(a, 'insertAdjacentElement', function (a, e) {
                    var d = l(e);
                    return (a = b.call(this, a, e)), d && z(c, e), l(a) && x(c, e), a;
                  });
                }
                function d(a, b) {
                  function e(a, b) {
                  ...
                  r(a, 'insertAdjacentHTML', function (a, c) {
                    if ('beforebegin' === (a = a.toLowerCase())) {
                      ...
                      b.call(this, a, c), e(d || this.parentNode.firstChild, this);
                ...
                N &&
                  ...
                  r(Element.prototype, 'setAttribute', function (a, b) {
                    ...
                    var e = P.call(this, a);
                    Q.call(this, a, b), (b = P.call(this, a)), c.attributeChangedCallback(this, a, e, b, null);
                  }),
                  r(Element.prototype, 'setAttributeNS', function (a, b, d) {
                    if (1 !== this.__CE_state) return T.call(this, a, b, d);
                    var e = S.call(this, a, b);
                    T.call(this, a, b, d), (d = S.call(this, a, b)), c.attributeChangedCallback(this, b, e, d, a);
                  }),
                  r(Element.prototype, 'removeAttribute', function (a) {
                    if (1 !== this.__CE_state) return R.call(this, a);
                    var b = P.call(this, a);
                    R.call(this, a), null !== b && c.attributeChangedCallback(this, a, b, null, null);
                  }),
                    ...
                    function b(b) {
                      return function (e) {
                        ...
                        for (var k = [], h = 0; h < c.length; h++) {
                          var m = c[h];
                          if ((m instanceof Element && l(m) && k.push(m), m instanceof DocumentFragment)) for (m = m.firstChild; m; m = m.nextSibling) d.push(m);
                          else d.push(m);
                        }
                        for (b.apply(this, c), c = 0; c < k.length; c++) z(a, k[c]);
                        if (l(this)) for (c = 0; c < d.length; c++) (k = d[c]) instanceof Element && x(a, k);
                      };
                    }
                      ...
                      void 0 !== ra &&
                        r(d, 'replaceWith', function (b) {
                          ...
                          for (var d = [], k = 0; k < e.length; k++) {
                            var h = e[k];
                            if ((h instanceof Element && l(h) && d.push(h), h instanceof DocumentFragment)) for (h = h.firstChild; h; h = h.nextSibling) c.push(h);
                            else c.push(h);
                          }
                          for (k = l(this), ra.apply(this, e), e = 0; e < d.length; e++) z(a, d[e]);
                          if (k) for (z(a, this), e = 0; e < c.length; e++) (d = c[e]) instanceof Element && x(a, d);
                        }),
                      void 0 !== sa &&
                        r(d, 'remove', function () {
                          var b = l(this);
...
//# sourceMappingURL=polyfills-dom.3c3d9e7e.iframe.bundle.js.map
