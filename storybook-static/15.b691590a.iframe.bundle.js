/*! For license information please see 15.b691590a.iframe.bundle.js.LICENSE.txt */
(window.webpackJsonp = window.webpackJsonp || []).push([
  [15],
  {
    './node_modules/@storybook/components/dist/esm/OverlayScrollbars-1355f44c.js': function (module, __webpack_exports__, __webpack_require__) {
      'use strict';
      ...
      var _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__('./node_modules/@storybook/components/dist/esm/index-681e4b07.js'),
      ...
      !(function (module) {
        var global;
        (global = 'undefined' != typeof window ? window : _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_22__.H),
          (module.exports = (function (window, document, undefined$1) {
            var _targets,
              ...
              VENDORS = (function () {
                ...
                return {
                  ...
                  _cssProperty: function _cssProperty(name) {
                    ...
                    for (
                      var resultPossibilities, v, currVendorWithoutDashes, uppercasedName = firstLetterToUpper(name), elmStyle = document.createElement('div')[LEXICON.s], i = 0;
                  ...
                  _cssPropertyValue: function _cssPropertyValue(property, values, suffix) {
                    ...
                    if (cssCache[LEXICON.hOP](name)) return result;
                    for (
                      var prop, dummyStyle = document.createElement('div')[LEXICON.s], possbleValues = values.split(' '), preparedSuffix = suffix || '', i = 0, v = -1;
              ...
              COMPATIBILITY = (function () {
                ...
                return {
                  ...
                  mBtn: function mBtn(event) {
                    ...
                    return event.which || button === undefined$1 ? event.which : 1 & button ? 1 : 2 & button ? 3 : 4 & button ? 2 : 0;
                  },
              ...
              EASING =
                ((_easingsMath = { p: MATH.PI, c: MATH.cos, s: MATH.sin, w: MATH.pow, t: MATH.sqrt, n: MATH.asin, a: MATH.abs, o: 1.70158 }),
                {
                  ...
                  easeInOutExpo: function easeInOutExpo(x, t, b, c, d) {
                    return 0 == t ? b : t == d ? b + c : (t /= d / 2) < 1 ? (c / 2) * _easingsMath.w(2, 10 * (t - 1)) + b : (c / 2) * (2 - _easingsMath.w(2, -10 * --t)) + b;
                  },
                  ...
                  easeInElastic: function easeInElastic(x, t, b, c, d) {
                    ...
                    return 0 == t
                      ...
                      ? b + c
                      : (p || (p = 0.3 * d),
                        a < _easingsMath.a(c) ? ((a = c), (s = p / 4)) : (s = (p / (2 * _easingsMath.p)) * _easingsMath.n(c / a)),
                        -a * _easingsMath.w(2, 10 * (t -= 1)) * _easingsMath.s(((t * d - s) * (2 * _easingsMath.p)) / p) + b);
                  },
                  easeOutElastic: function easeOutElastic(x, t, b, c, d) {
                    ...
                    return 0 == t
                      ...
                      : (p || (p = 0.3 * d),
                        a < _easingsMath.a(c) ? ((a = c), (s = p / 4)) : (s = (p / (2 * _easingsMath.p)) * _easingsMath.n(c / a)),
                        a * _easingsMath.w(2, -10 * t) * _easingsMath.s(((t * d - s) * (2 * _easingsMath.p)) / p) + c + b);
                  },
                  easeInOutElastic: function easeInOutElastic(x, t, b, c, d) {
                    ...
                    return 0 == t
                      ...
                      : (p || (p = d * (0.3 * 1.5)),
                        a < _easingsMath.a(c) ? ((a = c), (s = p / 4)) : (s = (p / (2 * _easingsMath.p)) * _easingsMath.n(c / a)),
                        t < 1
                          ? a * _easingsMath.w(2, 10 * (t -= 1)) * _easingsMath.s(((t * d - s) * (2 * _easingsMath.p)) / p) * -0.5 + b
                          : a * _easingsMath.w(2, -10 * (t -= 1)) * _easingsMath.s(((t * d - s) * (2 * _easingsMath.p)) / p) * 0.5 + c + b);
                  },
              ...
              FRAMEWORK = (function () {
                        ...
                        (src = target[name]),
                          target !== (copy = options[name]) &&
                            (deep && copy && (isPlainObject(copy) || (copyIsArray = COMPATIBILITY.isA(copy)))
                              ? (copyIsArray ? ((copyIsArray = !1), (clone = src && COMPATIBILITY.isA(src) ? src : [])) : (clone = src && isPlainObject(src) ? src : {}),
                ...
                function matches(elem, selector) {
                  for (var nodeList = (elem.parentNode || document).querySelectorAll(selector) || [], i = nodeList[LEXICON.l]; i--; ) if (nodeList[i] == elem) return !0;
                  return !1;
                }
                function insertAdjacentElement(el, strategy, child) {
                  if (COMPATIBILITY.isA(child)) for (var i = 0; i < child[LEXICON.l]; i++) insertAdjacentElement(el, strategy, child[i]);
                  else _type(child) == TYPES.s ? el.insertAdjacentHTML(strategy, child) : el.insertAdjacentElement(strategy, child.nodeType ? child : child[0]);
                }
                ...
                function startNextAnimationInQ(animObj, removeFromQ) {
                  ...
                  !1 !== removeFromQ && animObj.q.splice(0, 1),
                    animObj.q[LEXICON.l] > 0
                      ? ((nextAnim = animObj.q[0]), _animate(animObj.el, nextAnim.props, nextAnim.duration, nextAnim.easing, nextAnim.complete, !0))
                        ...
                        (timeStart = COMPATIBILITY.now()),
                          (_frame = function frame() {
                            ...
                            isFunction(progress) && progress({}, percent, MATH.max(0, duration - elapsed)),
                              end ? (startNextAnimationInQ(animObj), isFunction(complete) && complete()) : (qObj.frame = COMPATIBILITY.rAF()(_frame));
                          }),
                ...
                function FakejQuery(selector) {
                  ...
                  if (elements) {
                    for (
                      _type(elements) == TYPES.s || (isArrayLike(elements) && elements !== window && elements !== elements.self) || (elements = [elements]), i = 0;
                ...
                return (
                  (FakejQuery[LEXICON.p] = {
                    on: function on(eventName, handler) {
                      ...
                      return this.each(function () {
                        el = this;
                        try {
                          if (el.addEventListener) for (; i < eventNameLength; i++) el.addEventListener(eventName[i], handler);
                          else if (el.detachEvent) for (; i < eventNameLength; i++) el.attachEvent('on' + eventName[i], handler);
                        } catch (e) {}
                      });
                    },
                    off: function off(eventName, handler) {
                      ...
                      return this.each(function () {
                        el = this;
                        try {
                          if (el.removeEventListener) for (; i < eventNameLength; i++) el.removeEventListener(eventName[i], handler);
                          else if (el.detachEvent) for (; i < eventNameLength; i++) el.detachEvent('on' + eventName[i], handler);
                        } catch (e) {}
                      });
                    },
                      ...
                      return this.each(function () {
                        (el = this),
                          document.createEvent
                            ? ((event = document.createEvent('HTMLEvents')).initEvent(eventName, !0, !1), el.dispatchEvent(event))
                    ...
                    unwrap: function unwrap() {
                      ...
                      for (
                        ...
                        for (el = parents[i], parent = el.parentNode; el.firstChild; ) parent.insertBefore(el.firstChild, el);
                    ...
                    wrapAll: function wrapAll(wrapperHTML) {
                      for (
                        var i, nodes = this, wrapper = FakejQuery(wrapperHTML)[0], deepest = wrapper, parent = nodes[0].parentNode, previousSibling = nodes[0].previousSibling;
                      ...
                      return _type(styles) == TYPES.s
                        ? val === undefined$1
                          ? ((el = this[0]),
                            ...
                            getCptStyle ? (null != cptStyle ? cptStyle.getPropertyValue(styles) : el[LEXICON.s][styles]) : cptStyle)
                          : this.each(function () {
                    ...
                    hasClass: function hasClass(className) {
                      for (var elem, classList, i = 0, classNamePrepared = _strSpace + className + _strSpace; (elem = this[i++]); ) {
                        ...
                        if (1 === elem.nodeType && (_strSpace + stripAndCollapse(elem.className + _strEmpty) + _strSpace).indexOf(classNamePrepared) > -1) return !0;
                      }
                      return !1;
                    },
                    addClass: function addClass(className) {
                      ...
                      if (className)
                        for (classes = className.match(_rnothtmlwhite) || []; (elem = this[i++]); )
                          if (((elmClassList = elem.classList), supportClassList === undefined$1 && (supportClassList = elmClassList !== undefined$1), supportClassList))
                      ...
                      if (className)
                        for (classes = className.match(_rnothtmlwhite) || []; (elem = this[i++]); )
                          if (((elmClassList = elem.classList), supportClassList === undefined$1 && (supportClassList = elmClassList !== undefined$1), supportClassList))
                            ...
                            for (; (clazz = classes[v++]); ) for (; cur.indexOf(_strSpace + clazz + _strSpace) > -1; ) cur = cur.replace(_strSpace + clazz + _strSpace, _strSpace);
                            curValue !== (finalValue = stripAndCollapse(cur)) && (elem.className = finalValue);
                          }
                      return this;
                    },
                  ...
                  extend(FakejQuery, { extend: extend, inArray: inArray, isEmptyObject: isEmptyObject, isPlainObject: isPlainObject, each: _each }),
                  FakejQuery
                );
              })(),
              INSTANCES =
              ...
              PLUGIN = (function () {
                    ...
                    }),
                    {
                      _defaults: (convert = function convert(template) {
                        return (function recursive(obj) {
                          ...
                          for (key in obj)
                            obj[LEXICON.hOP](key) &&
                              ((val = obj[key]), (valType = type(val)) == TYPES.a ? (obj[key] = val[template ? 1 : 0]) : valType == TYPES.o && (obj[key] = recursive(val)));
                          return obj;
                      ...
                      _validate: function _validate(obj, template, writeErrors, diffObj) {
                        var validatedOptions = {},
                          ...
                          checkObjectProps = function checkObjectProps(data, template, diffData, validatedOptions, validatedOptionsPrepared, prevPropName) {
                            for (var prop in template)
                              if (template[LEXICON.hOP](prop) && data[LEXICON.hOP](prop)) {
                                ...
                                if (((dataDiffValue = dataDiffValue === undefined$1 ? {} : dataDiffValue), templateIsComplex && dataValueType == TYPES.o))
                                  ...
                                  for (i = 0; i < templateTypes[LEXICON.l]; i++)
                                    if (
                                      ...
                                      (isRestrictedValue = (templateValueType = type(currType)) == TYPES.s && -1 === inArray(currType, possibleTemplateTypes)))
                                    )
                                      for (
                                  ...
                                  isValid
                                    ? ((isDiff = dataValue !== dataDiffValue) && (validatedOptions[prop] = dataValue),
                                      (isRestrictedValue ? inArray(dataDiffValue, restrictedStringValuesPossibilitiesSplit) < 0 : isDiff) &&
                ...
                function initOverlayScrollbarsStatics() {
                  _pluginsGlobals || (_pluginsGlobals = new OverlayScrollbarsGlobals(_pluginsOptions._defaults)),
                    _pluginsAutoUpdateLoop || (_pluginsAutoUpdateLoop = new OverlayScrollbarsAutoUpdateLoop(_pluginsGlobals));
                }
                    ...
                    nativeScrollbarStyling: (function () {
                      ...
                      try {
                        result =
                          ...
                          'none' === window.getComputedStyle(scrollbarDummyElement0, '::-webkit-scrollbar').getPropertyValue('display');
                      } catch (ex) {}
                      return result;
                    })(),
                ...
                function OverlayScrollbarsAutoUpdateLoop(globals) {
                          ...
                          for (var i = 0; i < _loopingInstances[_strLength]; i++)
                            (instance = _loopingInstances[i]) !== undefined$1 &&
                              ...
                              (!0 === instanceAutoUpdateAllowed || null === instanceAutoUpdateAllowed) &&
                                ...
                                (instance.update('auto'), (_loopingInstancesIntervalCache[i] = new Date((now += instanceAutoUpdateInterval)))),
                  ...
                  (_base.add = function (instance) {
                    -1 === _inArray(instance, _loopingInstances) &&
                      ...
                      _loopingInstances[_strLength] > 0 && !_loopIsActive && ((_loopIsActive = !0), (globals.autoUpdateLoop = _loopIsActive), loop()));
                  }),
                    (_base.remove = function (instance) {
                      ...
                      index > -1 &&
                        ...
                        0 === _loopingInstances[_strLength] &&
                          _loopIsActive &&
                          ((_loopIsActive = !1), (globals.autoUpdateLoop = _loopIsActive), _loopID !== undefined$1 && (COMPATIBILITY.cAF()(_loopID), (_loopID = -1))));
                    });
                }
                function OverlayScrollbarsInstance(pluginTargetElement, options, extensions, globals, autoUpdateLoop) {
                  ...
                  if (isHTMLElement(pluginTargetElement)) {
                    ...
                    var _nativeScrollbarIsOverlaid,
                      ...
                      _mutationObserverAttrsHost = [LEXICON.i, LEXICON.c, LEXICON.s, 'open'].concat(_viewportAttrsFromTarget),
                      _destroyEvents = [];
                    return (
                              ...
                              ? force === _strAuto
                                ? ((attrsChanged = meaningfulAttrsChanged()),
                                  ...
                                  (doUpdateAuto = attrsChanged || contentSizeC) &&
                                    update({ _contentSizeChanged: contentSizeC, _changedOptions: _initialized ? undefined$1 : _currentPreparedOptions }))
                                : force === _strSync
                                ? _mutationObserversConnected
                      ...
                      (_base.destroy = function () {
                        if (!_destroyed) {
                          ...
                          (_updateOnLoadElms = undefined$1), (_destroyed = !0), (_sleeping = !0), INSTANCES(pluginTargetElement, 0), dispatchCallback('onDestroyed');
                        }
                      }),
                      (_base.scroll = function (coordinates, duration, easing, complete) {
                        ...
                        var i,
                          ...
                          possibleElementIsJQuery = !!(possibleElement instanceof FRAMEWORK || JQUERY) && possibleElement instanceof JQUERY,
                          ...
                          if (
                            (isString
                              ? (rawScroll[strLength] > 2 &&
                                  ((possibleOperator = rawScroll.substr(0, 2)), inArray(possibleOperator, coordinatesOperators) > -1 && (operator = possibleOperator)),
                                ...
                                (amount = parseToZeroOrNumber(isNaN(rawScroll) ? parseToZeroOrNumber(evalFunc(rawScroll), !0).toFixed() : rawScroll)))
                              : (amount = rawScroll),
                        ...
                        if (possibleElementIsJQuery || possibleElementIsHTMLElement) {
                          ...
                          if ((finalElement = possibleElementIsJQuery ? possibleElement : FRAMEWORK(possibleElement))[strLength] > 0) {
                            ...
                            var viewportScroll = { l: _scrollHorizontalInfo._currentScroll, t: _scrollVerticalInfo._currentScroll },
                              ...
                              doNotScroll = { x: settingsScroll.x == strNever || settingsAxis == _strY, y: settingsScroll.y == strNever || settingsAxis == _strX };
                            ...
                            if (
                              ...
                              settingsBlock.x != strBegin || settingsBlock.y != strBegin || settingsScroll.x == strIfNeeded || settingsScroll.y == strIfNeeded || _isRTL)
                            ) {
                              var measuringElm = finalElement[0],
                                rawElementSize = _supportTransform ? measuringElm[LEXICON.bCR]() : { width: measuringElm[LEXICON.oW], height: measuringElm[LEXICON.oH] },
                                elementSize = {
                                ...
                                finalizeBlock = function finalizeBlock(isX) {
                                  var vars = getScrollbarVars(isX),
                                    ...
                                    isInView = elSize <= vpSize && elOffset >= vpOffset && elOffset + elSize <= vpOffset + vpSize;
                                  scrollNever
                                    ? (doNotScroll[xy] = !0)
                                    : doNotScroll[xy] ||
                      ...
                      (_base.getElements = function (elementName) {
                        var obj = {
                          ...
                          scrollbarVertical: { scrollbar: _scrollbarVerticalElement[0], track: _scrollbarVerticalTrackElement[0], handle: _scrollbarVerticalHandleElement[0] },
                        ...
                        if (registeredExtensionObj) {
                          ...
                          if (
                            ...
                            type(instanceContract) == TYPES.f &&
                              ((contractResult = instanceContract(window)), (contractFulfilled = type(contractResult) == TYPES.b ? contractResult : contractFulfilled)),
                            contractFulfilled)
                          )
                            return (
                      ...
                      (_base.removeExt = function (extName) {
                        ...
                        return !!instance && (delete _extensions[extName], (instanceRemoved = instance.removed), type(instanceRemoved) == TYPES.f && instanceRemoved(), !0);
                      }),
                  ...
                  function setupResponsiveEventListener(element, eventNames, listener, remove, passiveOrOptions) {
                    ...
                    if (collected) for (; i < eventNames[LEXICON.l]; i++) setupResponsiveEventListener(element, eventNames[i], listener[i], remove, passiveOrOptions);
                    else for (; i < events[LEXICON.l]; i++) _supportPassiveEvents ? element[0][method](events[i], listener, nativeParam) : element[onOff](events[i], listener);
                  }
                  function addDestroyEventListener(element, eventNames, listener, passive) {
                    setupResponsiveEventListener(element, eventNames, listener, !1, passive),
                      _destroyEvents.push(COMPATIBILITY.bind(setupResponsiveEventListener, 0, element, eventNames, listener, !0, passive));
                  }
                    ...
                    if (targetElement) {
                      ...
                      if (onElementResizedCallback) {
                        if (_supportResizeObserver)
                          ((element = targetElement.addClass('observed').append(generateDiv(_classNameResizeObserverElement)).contents()[0])[_strResizeObserverProperty] =
                          ...
                          var isDirty,
                            ...
                            onScroll = function onScroll(event) {
                              return (
                                ...
                                event && isDirty && !rAFId ? (COMPATIBILITY.cAF()(rAFId), (rAFId = COMPATIBILITY.rAF()(onResized))) : event || onResized(),
                                reset(),
                                  ...
                                  (mutationTarget = (mutation = this).target),
                                    ...
                                    doUpdate ||
                                      (doUpdate = mutationIsClass
                                        ...
                                        : mutationAttrName !== LEXICON.s || oldMutationVal !== mutationTarget[LEXICON.s].cssText),
                  ...
                  function connectMutationObservers() {
                    _supportMutationObserver &&
                      !_mutationObserversConnected &&
                      (_mutationObserverHost.observe(_hostElementNative, { attributes: !0, attributeOldValue: !0, attributeFilter: _mutationObserverAttrsHost }),
                  ...
                  function disconnectMutationObservers() {
                    _supportMutationObserver &&
                      _mutationObserversConnected &&
                      (_mutationObserverHost.disconnect(), _mutationObserverContent.disconnect(), (_mutationObserversConnected = !1));
                  }
                  function hostOnResized() {
                    if (!_sleeping) {
                      var changed,
                        hostSize = { w: _sizeObserverElementNative[LEXICON.sW], h: _sizeObserverElementNative[LEXICON.sH] };
                  ...
                  function setupHostMouseTouchEvents(destroy) {
                    destroy || setupHostMouseTouchEvents(!0),
                      setupResponsiveEventListener(_hostElement, _strMouseTouchMoveEvent.split(_strSpace)[0], hostOnMouseMove, !_scrollbarsAutoHideMove || destroy, !0),
                      setupResponsiveEventListener(_hostElement, [_strMouseEnter, _strMouseLeave], [hostOnMouseEnter, hostOnMouseLeave], !_scrollbarsAutoHideLeave || destroy, !0),
                  ...
                  function hostClassNamesChanged(oldClassNames, newClassNames) {
                    var i,
                      ...
                      diff = getArrayDifferences(_typeof(oldClassNames) == TYPES.s ? oldClassNames.split(_strSpace) : [], currClasses),
                  ...
                  function updateAutoContentSizeChanged() {
                    ...
                    var float,
                      ...
                      css = {};
                    return (
                      setCSS && ((float = _contentElement.css(_strFloat)), (css[_strFloat] = _isRTL ? _strRight : _strLeft), (css[_strWidth] = _strAuto), _contentElement.css(css)),
                  ...
                  function update(updateHints) {
                    ...
                    var displayIsHidden,
                      ...
                      swallow = _initialized && !_destroyed && !force && !changedOptions && now - _lastUpdateTime < _swallowUpdateLag && !_heightAutoCache && !_widthAutoCache;
                    if (
                      ...
                      var checkCacheAutoForce = function checkCacheAutoForce() {
                        ...
                        scrollbarsVisibilityChanged = checkCacheAutoForce(scrollbarsVisibility, _scrollbarsVisibilityCache),
                        ...
                        scrollbarsClickScrollingChanged = checkCacheAutoForce(scrollbarsClickScrolling, _scrollbarsClickScrollingCache),
                        scrollbarsDragScrolling = currentPreparedOptionsScrollbars.dragScrolling,
                        scrollbarsDragScrollingChanged = checkCacheAutoForce(scrollbarsDragScrolling, _scrollbarsDragScrollingCache),
                        ...
                        ignoreOverlayScrollbarHiding = _currentPreparedOptions.nativeScrollbarsOverlaid.showNativeScrollbars,
                        ignoreOverlayScrollbarHidingChanged = checkCacheAutoForce(ignoreOverlayScrollbarHiding, _ignoreOverlayScrollbarHidingCache),
                      ...
                      if (
                        ...
                        classNameChanged &&
                          ...
                          addClass(_hostElement, className !== undefined$1 && null !== className && className.length > 0 ? className : _classNameThemeNone)),
                        autoUpdateChanged &&
                        ...
                        if (sizeAutoCapable)
                          if (
                            (_contentGlueElement
                              ...
                              : ((_contentGlueElement = FRAMEWORK(generateDiv(_classNameContentGlueElement))), _paddingElement.before(_contentGlueElement)),
                            _sizeAutoObserverAdded)
                          )
                      ...
                      force && (_sizeObserverElement.find('*').trigger(_strScroll), _sizeAutoObserverAdded && _sizeAutoObserverElement.find('*').trigger(_strScroll)),
                      ...
                      var sizeAutoObserverElementBCRect,
                        ...
                        textareaAutoWrappingChanged = checkCacheAutoForce(textareaAutoWrapping, _textareaAutoWrappingCache),
                      ...
                      if (
                        ...
                        widthAuto && (widthAutoChanged || paddingAbsoluteChanged || boxSizingChanged || padding.c || border.c || cssDirectionChanged)
                        ...
                        var contentMeasureElement = getContentMeasureElement(),
                          contentSize = { w: textareaDynOrigSize.w || contentMeasureElement[LEXICON.cW], h: textareaDynOrigSize.h || contentMeasureElement[LEXICON.cH] },
                          ...
                          var textareaCoverCSS = {},
                            setContentGlueElementCSSfunction = function setContentGlueElementCSSfunction(horizontal) {
                              var scrollbarVars = getScrollbarVars(horizontal),
                                ...
                                viewportSize = _viewportSize[wh] - borderSize - marginSize - (_isBorderBox ? 0 : paddingSize);
                              (!autoSize || (!autoSize && border.c)) && (contentGlueElementCSS[strWH] = hostAbsoluteRectSize[wh] - 1),
                                !(autoSize && contentSize[wh] < viewportSize) ||
                                  (horizontal && _isTextarea && textareaAutoWrapping) ||
                                  (_isTextarea && (textareaCoverCSS[strWH] = parseToZeroOrNumber(_textareaCoverElement.css(strWH)) - 1), (contentGlueElementCSS[strWH] -= 1)),
                                contentSize[wh] > 0 && (contentGlueElementCSS[strWH] = MATH.max(1, contentGlueElementCSS[strWH]));
                            };
                        ...
                        var hideOverflowForceTextarea = _isTextarea && (0 === _viewportSize.w || 0 === _viewportSize.h),
                          ...
                          setOverflowVariables = function setOverflowVariables(horizontal) {
                            var scrollbarVars = getScrollbarVars(horizontal),
                              ...
                              checkFractionalOverflowAmount = previousOverflowAmount && previousOverflowAmount[xy] > 0 && 0 === _viewportElementNative[scrollMax];
                            (overflowBehaviorIsVS[xy] = 'v-s' === overflowBehavior[xy]),
                              ...
                              (overflowAmount[xy] = MATH.max(0, MATH.round(100 * (contentScrollSize[wh] - _viewportSize[wh])) / 100)),
                              (overflowAmount[xy] *=
                              ...
                              (hideOverflow[xy] =
                                overflowBehaviorIsVS[xy] || overflowBehaviorIsVH[xy]
                                  ...
                                  : hasOverflow[xy]),
                              (hideOverflow[xy + 's'] = !!hideOverflow[xy] && (overflowBehaviorIsS[xy] || overflowBehaviorIsVS[xy])),
                        ...
                        if (
                          ...
                          (hasOverflow.x || hasOverflow.y) &&
                                ...
                                _nativeScrollbarIsOverlaid[xy] && hasOverflow[xy] && hideOverflow[xy + 's']
                                  ? ((contentElementCSS[_strMarginMinus + strDirection] = invertedAutoSize
                                    ...
                                    (contentElementCSS[_strBorderMinus + strDirection] =
                                      (horizontal && invertedAutoSize) || ignoreOverlayScrollbarHiding ? _strEmpty : _overlayScrollbarDummySize[xy] + borderDesign))
                            ...
                            arrangeChanged &&
                              ...
                              _contentArrangeElement ||
                                ((_contentArrangeElement = FRAMEWORK(generateDiv(_classNameContentArrangeElement))), _viewportElement.prepend(_contentArrangeElement)),
                        ...
                        if (
                          ...
                          (hostSizeChanged ||
                            ...
                            (hasOverflow.x && hideOverflow.x) || (hasOverflow.y && hideOverflow.y) || hideOverflowForceTextarea
                              ? _isTextarea && hideOverflowForceTextarea && (paddingElementCSS[strOverflowX] = paddingElementCSS[strOverflowY] = strHidden)
                              : (!clipAlways || overflowBehaviorIsVH.x || overflowBehaviorIsVS.x || overflowBehaviorIsVH.y || overflowBehaviorIsVS.y) &&
                        ...
                        if (((contentElementCSS = {}), cssDirectionChanged || widthAutoChanged || heightAutoChanged))
                          if (_isRTL && widthAuto) {
                            ...
                            _contentElement.css(_strFloat, floatTmp),
                              posLeftWithoutFloat !== MATH.round(_contentElement.position().left) && (contentElementCSS[_strLeft] = posLeftWithoutFloat);
                          } else contentElementCSS[_strLeft] = _strEmpty;
                        if ((_contentElement.css(contentElementCSS), _isTextarea && contentSizeChanged)) {
                          var textareaInfo = getTextareaInfo();
                          if (textareaInfo) {
                            var textareaRowsChanged = _textareaInfoCache === undefined$1 || textareaInfo._rows !== _textareaInfoCache._rows,
                              ...
                              cursorIsLastPosition = textareaInfo._cursorPosition >= textareaInfo._cursorMax && _textareaHasFocus,
                              textareaScrollAmount = {
                                x: textareaAutoWrapping || cursorCol !== lastCol || cursorRow !== widestRow ? -1 : _overflowAmountCache.x,
                                y: (
                                  textareaAutoWrapping
                                    ? cursorIsLastPosition || (textareaRowsChanged && previousOverflowAmount && currScroll.y === previousOverflowAmount.y)
                        ...
                        _isRTL && _rtlScrollBehavior.i && _nativeScrollbarIsOverlaid.y && hasOverflow.x && _normalizeRTLCache && (currScroll.x += _contentBorderSize.w || 0),
                        ...
                        var scrollbarsVisibilityVisible = 'v' === scrollbarsVisibility,
                          ...
                          refreshScrollbarsVisibility = function refreshScrollbarsVisibility(showX, showY) {
                            (showY = showY === undefined$1 ? showX : showY), refreshScrollbarAppearance(!0, showX, canScroll.x), refreshScrollbarAppearance(!1, showY, canScroll.y);
                          };
                        addRemoveClass(_hostElement, _classNameHostOverflow, hideOverflow.x || hideOverflow.y),
                          ...
                          (scrollbarsVisibilityChanged || overflowBehaviorChanged || hideOverflow.c || hasOverflow.c || ignoreOverlayScrollbarHidingChanged) &&
                            (ignoreOverlayScrollbarHiding
                              ? ignoreOverlayScrollbarHidingChanged &&
                                (removeClass(_hostElement, _classNameHostScrolling), ignoreOverlayScrollbarHiding && refreshScrollbarsVisibility(!1))
                          ...
                          (hostSizeChanged ||
                            ...
                            ignoreOverlayScrollbarHidingChanged ||
                            cssDirectionChanged) &&
                            (refreshScrollbarHandleLength(!0), refreshScrollbarHandleOffset(!0), refreshScrollbarHandleLength(!1), refreshScrollbarHandleOffset(!1)),
                      ...
                      _isBody &&
                        ...
                        _nativeScrollbarIsOverlaid.y && _hasOverflowCache.x && _contentElement.css(_strMinMinus + _strWidth, _bodyMinSizeCache.w + _overlayScrollbarDummySize.y),
                        _nativeScrollbarIsOverlaid.x && _hasOverflowCache.y && _contentElement.css(_strMinMinus + _strHeight, _bodyMinSizeCache.h + _overlayScrollbarDummySize.x),
                      ...
                      eachUpdateOnLoad(function (i, updateOnLoadSelector) {
                        _contentElement.find(updateOnLoadSelector).each(function (i, el) {
                          COMPATIBILITY.inA(el, _updateOnLoadElms) < 0 &&
                            (_updateOnLoadElms.push(el), FRAMEWORK(el).off(_updateOnLoadEventName, updateOnLoadCallback).on(_updateOnLoadEventName, updateOnLoadCallback));
                        });
                      });
                  }
                  function setOptions(newOptions) {
                    var validatedOpts = _pluginsOptions._validate(newOptions, _pluginsOptions._template, !0, _currentOptions);
                    return (
                    ...
                    (_hostElement =
                      ...
                      destroy
                        ...
                        : (_isTextarea &&
                          ...
                          _nativeScrollbarIsOverlaid.x && _nativeScrollbarIsOverlaid.y && addClass(_viewportElement, _classNameViewportNativeScrollbarsOverlaid),
                  ...
                  function setupStructureEvents() {
                    var textareaUpdateIntervalID,
                      scrollStopTimeoutId,
                      textareaKeyDownRestrictedKeyCodes = [112, 113, 114, 115, 116, 117, 118, 119, 120, 121, 123, 33, 34, 37, 38, 39, 40, 16, 17, 18, 19, 20, 144],
                    ...
                    function textareaOnKeyDown(event) {
                      ...
                      inArray(keyCode, textareaKeyDownRestrictedKeyCodes) < 0 &&
                        (textareaKeyDownKeyCodesList[LEXICON.l] || (updateTextarea(), (textareaUpdateIntervalID = setInterval(updateTextarea, 1e3 / 60))),
                  ...
                  function setupScrollbarsDOM(destroy) {
                    ...
                    destroy
                      ...
                      : ((horizontalElements = selectOrGenerateScrollbarDOM(!0)),
                        ...
                        _domExists || (_paddingElement.after(_scrollbarVerticalElement), _paddingElement.after(_scrollbarHorizontalElement)));
                  }
                  function setupScrollbarEvents(isHorizontal) {
                    ...
                    function documentDragMove(event) {
                      if (onMouseTouchDownContinue(event)) {
                        var trackLength = scrollbarVarsInfo._trackLength,
                          ...
                          scrollDelta = scrollbarVarsInfo._maxScroll * (((getPointerPosition(event) - mouseDownOffset) * mouseDownInvertedScale) / (trackLength - handleLength));
                        (scrollDelta = isFinite(scrollDelta) ? scrollDelta : 0),
                          _isRTL && isHorizontal && !_rtlScrollBehavior.i && (scrollDelta *= -1),
                          _viewportElement[scroll](MATH.round(mouseDownScroll + scrollDelta)),
                          _scrollbarsHandlesDefineScrollPos && refreshScrollbarHandleOffset(isHorizontal, mouseDownScroll + scrollDelta),
                    ...
                    function documentMouseTouchUp(event) {
                      if (
                        ...
                        trackTimeout !== undefined$1 && (_base.scrollStop(), clearTimeout(trackTimeout), (trackTimeout = undefined$1)),
                        event)
                      ) {
                        var rect = _hostElementNative[LEXICON.bCR]();
                        (event.clientX >= rect.left && event.clientX <= rect.right && event.clientY >= rect.top && event.clientY <= rect.bottom) || hostOnMouseLeave(),
                          (_scrollbarsAutoHideScroll || _scrollbarsAutoHideMove) && refreshScrollbarsAutoHide(!1);
                      }
                    }
                    ...
                    function onHandleMouseTouchDownAction(event) {
                      (mouseDownScroll = _viewportElement[scroll]()),
                        ...
                        ((_isRTL && isHorizontal && !_rtlScrollBehavior.n) || !_isRTL) && (mouseDownScroll = mouseDownScroll < 0 ? 0 : mouseDownScroll),
                      ...
                      if (onMouseTouchDownContinue(event)) {
                        var decreaseScroll,
                          handleToViewportRatio =
                            ...
                            Math.round(MATH.min(1, _viewportSize[scrollbarVars._w_h] / _contentScrollSizeCache[scrollbarVars._w_h]) * scrollbarVars._info._trackLength),
                                ...
                                instantScroll
                                  ...
                                  : ((decreaseScroll = isFirstIteration ? decreaseScrollCondition : decreaseScroll),
                                    (
                                      ...
                                      ? (clearTimeout(trackTimeout), _base.scrollStop(), (trackTimeout = undefined$1), scrollActionFinsished(!0))
                  ...
                  function refreshScrollbarAppearance(isHorizontal, shallBeVisible, canScroll) {
                    ...
                    addRemoveClass(_hostElement, isHorizontal ? _classNameHostScrollbarHorizontalHidden : _classNameHostScrollbarVerticalHidden, !shallBeVisible),
                  ...
                  function refreshScrollbarHandleOffset(isHorizontal, scrollOrTransition) {
                    var transformOffset,
                      ...
                      currentScroll = scrollOrTransition === undefined$1 || transition ? nativeScroll : scrollOrTransition,
                      handleLength = scrollbarVarsInfo._handleLength,
                  ...
                  function refreshScrollbarsInteractive(isTrack, value) {
                    ...
                    (isTrack ? _scrollbarHorizontalTrackElement : _scrollbarHorizontalHandleElement)[action](className), element2[action](className);
                  }
                    ...
                    function documentDragMove(event) {
                      if (onMouseTouchDownContinue(event)) {
                        var pageOffset = getCoordinates(event),
                          hostElementCSS = {};
                        (_resizeHorizontal || _resizeBoth) && (hostElementCSS[_strWidth] = mouseDownSize.w + (pageOffset.x - mouseDownPosition.x) * mouseDownInvertedScale.x),
                          (_resizeVertical || _resizeBoth) && (hostElementCSS[_strHeight] = mouseDownSize.h + (pageOffset.y - mouseDownPosition.y) * mouseDownInvertedScale.y),
                  ...
                  function dispatchCallback(name, args, dependent) {
                    if (!1 !== dependent)
                      if (_initialized) {
                        ...
                        'on' === extensionOnName.substr(0, 2) && (extensionOnName = extensionOnName.substr(2, 1).toLowerCase() + extensionOnName.substr(3)),
                      ...
                      (classesOrAttrs
                        ? type(classesOrAttrs) == TYPES.s
                          ...
                          : (function () {
                              var key,
                                attrs = _strEmpty;
                              if (FRAMEWORK.isPlainObject(classesOrAttrs)) for (key in classesOrAttrs) attrs += ('c' === key ? 'class' : key) + '="' + classesOrAttrs[key] + '" ';
                              return attrs;
                            })()
                        : _strEmpty) +
                      '>' +
                      ...
                      _nativeScrollbarIsOverlaid.x && _nativeScrollbarIsOverlaid.y && !_currentPreparedOptions.nativeScrollbarsOverlaid.initialize
                        ...
                        : (_isBody &&
                            ...
                            (_bodyMouseTouchDownListener = function bodyMouseTouchDownListener() {
                              _viewportElement.removeAttr(LEXICON.ti), setupResponsiveEventListener(_viewportElement, _strMouseTouchDownEvent, _bodyMouseTouchDownListener, !0, !0);
                            })),
                          setupStructureDOM(),
                          setupScrollbarsDOM(),
                          ...
                          _isBody &&
                            ...
                            document.activeElement == targetElement &&
                              ...
                              _viewportElementNative.focus(),
                              setupResponsiveEventListener(_viewportElement, _strMouseTouchDownEvent, _bodyMouseTouchDownListener, !1, !0))),
                ...
                return (
                          ...
                          pluginTargetElements[LEXICON.l] > 0 &&
                            (optsIsPlainObj
                              ? FRAMEWORK.each(pluginTargetElements, function (i, v) {
                                  (inst = v) !== undefined$1 && arr.push(OverlayScrollbarsInstance(inst, options, extensions, _pluginsGlobals, _pluginsAutoUpdateLoop));
                                })
                              : FRAMEWORK.each(pluginTargetElements, function (i, v) {
                                  (inst = INSTANCES(v)),
                                    (('!' === options && _plugin.valid(inst)) || (COMPATIBILITY.type(options) == TYPES.f && options(v, inst)) || options === undefined$1) &&
                                      arr.push(inst);
                                }),
                  ...
                  (_plugin.defaultOptions = function (newDefaultOptions) {
                    ...
                    _pluginsGlobals.defaultOptions = FRAMEWORK.extend(
                      ...
                      {},
                      currDefaultOptions,
                      _pluginsOptions._validate(newDefaultOptions, _pluginsOptions._template, !0, currDefaultOptions)._default,
                    );
                  }),
                  ...
                  (_plugin.extension = function (extensionName, extension, defaultOptions) {
                    var extNameTypeString = COMPATIBILITY.type(extensionName) == TYPES.s,
                      ...
                      i = 0;
                    if (argLen < 1 || !extNameTypeString) return FRAMEWORK.extend(!0, { length: _pluginsExtensions[LEXICON.l] }, _pluginsExtensions);
                    if (extNameTypeString)
                      if (COMPATIBILITY.type(extension) == TYPES.f) _pluginsExtensions.push({ name: extensionName, extensionFactory: extension, defaultOptions: defaultOptions });
                      else
      ...
      var OverlayScrollbars = OverlayScrollbars$1.exports,
        OverlayScrollbarsComponent = function OverlayScrollbarsComponent(_a) {
          var _a$options = _a.options,
            ...
            rest = Object(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_22__.I)(_a, ['options', 'extensions', 'className', 'children']),
          ...
          return (
            Object(react__WEBPACK_IMPORTED_MODULE_23__.useEffect)(function () {
              return (
                ...
                function () {
                  OverlayScrollbars.valid(osInstance.current) && (osInstance.current.destroy(), (osInstance.current = null));
                }
              );
            }, []),
            ...
            react__WEBPACK_IMPORTED_MODULE_23___default.a.createElement(
              ...
              react__WEBPACK_IMPORTED_MODULE_23___default.a.createElement('div', { className: 'os-resize-observer-host' }),
              react__WEBPACK_IMPORTED_MODULE_23___default.a.createElement(
                'div',
                ...
                react__WEBPACK_IMPORTED_MODULE_23___default.a.createElement(
                  ...
                  react__WEBPACK_IMPORTED_MODULE_23___default.a.createElement('div', { className: 'os-content' }, children),
                ),
              ),
              react__WEBPACK_IMPORTED_MODULE_23___default.a.createElement(
                'div',
                ...
                react__WEBPACK_IMPORTED_MODULE_23___default.a.createElement(
                  ...
                  react__WEBPACK_IMPORTED_MODULE_23___default.a.createElement('div', { className: 'os-scrollbar-handle' }),
                ),
              ),
              react__WEBPACK_IMPORTED_MODULE_23___default.a.createElement(
                'div',
...
//# sourceMappingURL=15.b691590a.iframe.bundle.js.map
