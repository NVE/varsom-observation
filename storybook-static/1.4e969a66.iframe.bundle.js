/*! For license information please see 1.4e969a66.iframe.bundle.js.LICENSE.txt */
(window.webpackJsonp = window.webpackJsonp || []).push([
  [1],
  {
    './node_modules/@storybook/components/dist/esm/syntaxhighlighter-b07b042a.js': function (module, __webpack_exports__, __webpack_require__) {
      'use strict';
      ...
      var _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__('./node_modules/@storybook/components/dist/esm/index-681e4b07.js'),
        react__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__('./node_modules/react/index.js'),
        react__WEBPACK_IMPORTED_MODULE_36___default = __webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_36__),
        _storybook_client_logger__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__('./node_modules/@storybook/client-logger/dist/esm/index.js'),
        _storybook_theming__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__('./node_modules/@storybook/theming/dist/esm/index.js'),
        memoizerific__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__('./node_modules/memoizerific/memoizerific.js'),
        memoizerific__WEBPACK_IMPORTED_MODULE_39___default = __webpack_require__.n(memoizerific__WEBPACK_IMPORTED_MODULE_39__);
      ...
      function _slicedToArray(arr, i) {
        return (
          ...
          (function _unsupportedIterableToArray2(o, minLen) {
            ...
            if ('Arguments' === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray2(o, minLen);
          })(arr, i) ||
      ...
      function jsx(Prism) {
        !(function (Prism) {
          ...
          (spread = re(spread).source),
            ...
            Prism.languages.insertBefore('inside', 'attr-name', { spread: { pattern: re(/<SPREAD>/.source), inside: Prism.languages.jsx } }, Prism.languages.jsx.tag),
            Prism.languages.insertBefore(
              ...
              'special-attr',
              {
                script: {
                  ...
                  inside: { 'script-punctuation': { pattern: /^=(?=\{)/, alias: 'punctuation' }, 'rest': Prism.languages.jsx },
                },
              },
              Prism.languages.jsx.tag,
            );
          var stringifyToken = function stringifyToken(token) {
              return token ? ('string' == typeof token ? token : 'string' == typeof token.content ? token.content : token.content.map(stringifyToken).join('')) : '';
            },
                  ...
                  ('string' != typeof token &&
                    ('tag' === token.type && token.content[0] && 'tag' === token.content[0].type
                      ? '</' === token.content[0].content[0].content
                        ? openedTags.length > 0 && openedTags[openedTags.length - 1].tagName === stringifyToken(token.content[0].content[1]) && openedTags.pop()
                        : '/>' === token.content[token.content.length - 1].content || openedTags.push({ tagName: stringifyToken(token.content[0].content[1]), openedBraces: 0 })
                      : openedTags.length > 0 && 'punctuation' === token.type && '{' === token.content
                      ? openedTags[openedTags.length - 1].openedBraces++
                      : openedTags.length > 0 && openedTags[openedTags.length - 1].openedBraces > 0 && 'punctuation' === token.type && '}' === token.content
                      ? openedTags[openedTags.length - 1].openedBraces--
                      : (notTagNorBrace = !0)),
                  (notTagNorBrace || 'string' == typeof token) && openedTags.length > 0 && 0 === openedTags[openedTags.length - 1].openedBraces)
                ) {
        ...
        !(function (Prism) {
          ...
          (Prism.languages.bash = {
            ...
            'string': [
              ...
              { pattern: /(^|[^\\](?:\\\\)*)"(?:\\[\s\S]|\$\([^)]+\)|\$(?!\()|`[^`]+`|[^"\\`$])*"/, lookbehind: !0, greedy: !0, inside: insideString },
      ...
      function css$1(Prism) {
        !(function (Prism) {
          ...
          (Prism.languages.css = {
            ...
            selector: { pattern: RegExp('(^|[{}\\s])[^{}\\s](?:[^{};"\'\\s]|\\s+(?![\\s{])|' + string.source + ')*(?=\\s*\\{)'), lookbehind: !0 },
        ...
        !(function (Prism) {
          ...
          Prism.languages.insertBefore('javascript', 'function-variable', {
            ...
            Prism.languages.insertBefore('javascript', 'function', {
              method: { pattern: RegExp('(\\.\\s*)' + Prism.languages.javascript.function.source), lookbehind: !0, alias: ['function', 'property-access'] },
            }),
            ...
            Prism.languages.insertBefore('javascript', 'keyword', {
              ...
              exports: { pattern: withId(/(\bexport\b\s*)(?:\*(?:\s*as\s+<ID>)?(?=\s*\bfrom\b)|\{[^{}]*\})/.source), lookbehind: !0, inside: Prism.languages.javascript },
            }),
            ...
            Prism.languages.insertBefore('javascript', 'operator', { spread: { pattern: /\.{3}/, alias: 'operator' }, arrow: { pattern: /=>/, alias: 'operator' } }),
        ...
        (Prism.languages.markup = {
          ...
          Object.defineProperty(Prism.languages.markup.tag, 'addInlined', {
            value: function addInlined(tagName, lang) {
              ...
              (includedCdataInside['language-' + lang] = { pattern: /(^<!\[CDATA\[)[\s\S]+?(?=\]\]>$)/i, lookbehind: !0, inside: Prism.languages[lang] }),
              ...
              Prism.languages.markup.tag.inside['special-attr'].push({
                ...
                inside: {
                  ...
                  'attr-value': {
                    pattern: /=[\s\S]+/,
                    inside: {
                      value: { pattern: /(^=\s*(["']|(?!["'])))\S[\s\S]*(?=\2$)/, lookbehind: !0, alias: [lang, 'language-' + lang], inside: Prism.languages[lang] },
          ...
          (Prism.languages.markdown = Prism.languages.extend('markup', {})),
            Prism.languages.insertBefore('markdown', 'prolog', {
              'front-matter-block': {
                ...
                lookbehind: !0,
                greedy: !0,
                inside: { 'punctuation': /^---|---$/, 'front-matter': { pattern: /\S+(?:\s+\S+)*/, alias: ['yaml', 'language-yaml'], inside: Prism.languages.yaml } },
              },
              ...
              'table': {
                ...
                inside: {
                  'table-data-rows': {
                    ...
                    lookbehind: !0,
                    inside: { 'table-data': { pattern: RegExp(tableCell), inside: Prism.languages.markdown }, 'punctuation': /\|/ },
                  },
                  'table-line': { pattern: RegExp('^(' + tableRow + ')' + tableLine + '$'), lookbehind: !0, inside: { punctuation: /\||:?-{3,}:?/ } },
                  'table-header-row': {
                    pattern: RegExp('^' + tableRow + '$'),
                    inside: { 'table-header': { pattern: RegExp(tableCell), alias: 'important', inside: Prism.languages.markdown }, 'punctuation': /\|/ },
                  },
                },
              },
              'code': [
                  ...
                  env.content = Prism.highlight(
                    (function textContent(html) {
                      ...
                      return (text = text.replace(/&(\w{1,8}|#x?[\da-f]{1,8});/gi, function (m, code) {
                        var value;
                        if ('#' === (code = code.toLowerCase())[0]) return (value = 'x' === code[1] ? parseInt(code.slice(2), 16) : Number(code.slice(1))), fromCodePoint(value);
          ...
          delete typeInside['class-name'],
            ...
            Prism.languages.insertBefore('typescript', 'function', {
              ...
              'generic-function': {
                ...
                greedy: !0,
                inside: { function: /^#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*/, generic: { pattern: /<[\s\S]+/, alias: 'class-name', inside: typeInside } },
              },
            }),
      ...
      function tsx(Prism) {
        Prism.register(refractorJsx),
          ...
          (function (Prism) {
            ...
            (Prism.languages.tsx = Prism.languages.extend('jsx', typescript)), delete Prism.languages.tsx.parameter, delete Prism.languages.tsx['literal-property'];
      ...
      function createElement(_ref) {
        ...
        if (TagName) {
              ...
              return function (children) {
                return (
                  ...
                  children.map(function (child, i) {
                    return createElement({ node: child, stylesheet: stylesheet, useInlineStyles: useInlineStyles, key: 'code-segment-'.concat(childrenCount, '-').concat(i) });
                  })
                );
              };
          ...
          return react__WEBPACK_IMPORTED_MODULE_36___default.a.createElement(TagName, Object(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.m)({ key: key }, props), children);
        }
      }
      ...
      function AllLineNumbers(_ref2) {
        var codeString = _ref2.codeString,
          ...
          containerStyle = void 0 === _ref2$containerStyle ? { float: 'left', paddingRight: '10px' } : _ref2$containerStyle,
        ...
        return react__WEBPACK_IMPORTED_MODULE_36___default.a.createElement(
          ...
          (function getAllLineNumbers(_ref) {
            ...
            return lines.map(function (_, i) {
              ...
              return react__WEBPACK_IMPORTED_MODULE_36___default.a.createElement(
                'span',
                { key: 'line-'.concat(i), className: 'react-syntax-highlighter-line-number', style: 'function' == typeof style ? style(number) : style },
                ''.concat(number, '\n'),
              );
            });
      ...
      function getInlineLineNumber(lineNumber, inlineLineNumberStyle) {
        return {
          type: 'element',
          tagName: 'span',
          properties: { key: 'line-number--'.concat(lineNumber), className: ['comment', 'linenumber', 'react-syntax-highlighter-line-number'], style: inlineLineNumberStyle },
      ...
      function assembleLineNumberStyles(lineNumberStyle, lineNumber, largestLineNumber) {
        return _objectSpread(
          {},
          { display: 'inline-block', minWidth: getEmWidthOfNumber(largestLineNumber), paddingRight: '1em', textAlign: 'right', userSelect: 'none' },
      ...
      function createLineElement(_ref3) {
        ...
        return (
          wrapLongLines & showLineNumbers && (properties.style = _objectSpread({}, properties.style, { display: 'flex' })),
          { type: 'element', tagName: 'span', properties: properties, children: children }
        );
      }
      function flattenCodeTree(tree) {
        for (
          var className = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [], newTree = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : [], i = 0;
          i < tree.length;
          i++
        ) {
          var node = tree[i];
          if ('text' === node.type) newTree.push(createLineElement({ children: [node], className: _toConsumableArray(new Set(className)) }));
              ...
              splitValue.forEach(function (text, i) {
                ...
                if (0 === i) {
                  var _line = createLine(
                    tree.slice(lastLineBreakIndex + 1, index).concat(createLineElement({ children: [newChild], className: node.properties.className })),
                    lineNumber,
                  );
                  newTree.push(_line);
      ...
      function defaultRenderer(_ref5) {
        ...
        return rows.map(function (node, i) {
          return createElement({ node: node, stylesheet: stylesheet, useInlineStyles: useInlineStyles, key: 'code-segement'.concat(i) });
        });
      }
      ...
      var xtend = immutable,
        ...
        merge_1 = function merge$1(definitions) {
          var info,
            ...
            normal = [],
            index = -1;
          for (; ++index < length; ) (info = definitions[index]), property.push(info.property), normal.push(info.normal), (space = info.space);
      ...
      var xmlns$1 = create_1({ space: 'xmlns', attributes: { xmlnsxlink: 'xmlns:xlink' }, transform: caseInsensitiveTransform_1, properties: { xmlns: null, xmlnsXLink: null } }),
        types$1 = types$3,
        create$1 = create_1,
          ...
          for (; start < value.length; )
            (search.lastIndex = start),
              ...
              (subvalue = value.slice(start, match ? match.index : value.length)) &&
                (previous ? ('#' === previous ? (props.id = subvalue) : props.className ? props.className.push(subvalue) : (props.className = [subvalue])) : (name = subvalue),
      ...
      var commaSeparatedTokens = {
          ...
          stringify: function stringify$1(values, options) {
            ...
            values[values.length - 1] === empty$1 && (values = values.concat(empty$1));
                ...
                (function isChildren(value, node) {
                  return (
                    ...
                    (function isNode(tagName, value) {
                      ...
                      if (((type = type.toLowerCase()), 'button' === tagName)) return 'menu' !== type && 'submit' !== type && 'reset' !== type && 'button' !== type;
      ...
      function addChild(nodes, value) {
        ...
        if ('string' != typeof value && 'number' != typeof value)
          if ('object' === _typeof(value) && 'length' in value) for (index = -1, length = value.length; ++index < length; ) addChild(nodes, value[index]);
          else {
            if ('object' !== _typeof(value) || !('type' in value)) throw new Error('Expected node, nodes, or string, got `' + value + '`');
            nodes.push(value);
          }
      ...
      function parsePrimitive(info, name, value) {
        ...
        return (
          info.number || info.positiveNumber
            ...
            : (info.boolean || info.overloadedBoolean) && ('string' != typeof result || ('' !== result && normalize(value) !== normalize(name)) || (result = !0)),
          result
        );
      }
                ...
                for (
                  begin = start = index + 1,
                    ...
                    following === numberSign
                      ? ((end = ++begin), (following = value.charCodeAt(end)) === uppercaseX || following === lowercaseX ? ((type = hexa), (end = ++begin)) : (type = deci))
                      : (type = name),
                    entityCharacters = '',
                    entity = '',
                    characters = '',
                  ...
                  (characters += fromCharCode(following)), type === name && own$1.call(legacy, characters) && ((entityCharacters = characters), (entity = legacy[characters]));
                (terminated = value.charCodeAt(end) === semicolon) &&
                        ...
                        : (terminated || warning(numericNotTerminated, diff),
                          prohibited((reference = parseInt(characters, bases[type])))
                            ...
                            : ((output = ''),
                              ...
                              reference > 65535 && ((output += fromCharCode(((reference -= 65536) >>> 10) | 55296)), (reference = 56320 | (1023 & reference))),
                  ...
                  reference
                    ? (flush(),
                      ...
                      (next = now()).offset++,
                      handleReference && handleReference.call(referenceContext, reference, { start: prev, end: next }, value.slice(start - 1, end)),
                      (prev = next))
                    : ((characters = value.slice(start - 1, end)), (queue += characters), (column += characters.length), (index = end - 1));
              } else 10 === character && (line++, lines++, (column = 0)), character == character ? ((queue += fromCharCode(character)), column++) : flush();
            return result.join('');
            function now() {
      ...
      !(function (module) {
            ...
            _ = {
                  ...
                  for (var i in o)
                    if (o.hasOwnProperty(i)) {
                      ...
                      'Object' !== propertyType || visited[objId(property)]
                        ? 'Array' !== propertyType || visited[objId(property)] || ((visited[objId(property)] = !0), DFS(property, callback, i, visited))
              ...
              highlightElement: function highlightElement(element, async, callback) {
                ...
                if (
                  ...
                  (parent = env.element.parentElement) && 'pre' === parent.nodeName.toLowerCase() && !parent.hasAttribute('tabindex') && parent.setAttribute('tabindex', '0'),
                  !env.code)
                )
                    ...
                    if (!(str instanceof Token)) {
                      ...
                      if (greedy) {
                        ...
                        var from = match.index,
                          ...
                          p = pos;
                        for (p += currentNode.value.length; from >= p; ) p += (currentNode = currentNode.next).value.length;
                        if (((pos = p -= currentNode.value.length), currentNode.value instanceof Token)) continue;
                        for (var k = currentNode; k !== tokenList.tail && (p < to || 'string' == typeof k.value); k = k.next) removeCount++, (p += k.value.length);
                      ...
                      if (
                        ...
                        (currentNode = addAfter(tokenList, removeFrom, new Token(token, inside ? _.tokenize(matchStr, inside) : matchStr, alias, matchStr))),
        ...
        module.exports && (module.exports = Prism),
          void 0 !== _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.H && (_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.H.Prism = Prism);
      })(prismCore);
      var clike_1 = clike$1;
      ...
      var ctx =
          'object' === ('undefined' == typeof globalThis ? 'undefined' : _typeof(globalThis))
            ...
            ? window
            : 'object' === _typeof(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.H)
            ? _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.H
            : {},
      ...
      function register(grammar) {
        if ('function' != typeof grammar || !grammar.displayName) throw new Error('Expected `function` for `grammar`, got `' + grammar + '`');
      ...
      (refract.highlight = function highlight(value, name) {
        ...
        (refract.alias = function alias(name, alias) {
          ...
          for (key in map)
            for (length = (list = 'string' == typeof (list = map[key]) ? [list] : list).length, index = -1; ++index < length; ) languages[list[index]] = languages[key];
        }),
        ...
        (refract.listLanguages = function listLanguages() {
          var language,
            languages = refract.languages,
            list = [];
          for (language in languages) own.call(languages, language) && 'object' === _typeof(languages[language]) && list.push(language);
          return list;
        }),
        register(markup),
        register(css),
        ...
        (refract.Token.stringify = function stringify(value, language, parent) {
          ...
          if ('Array' === refract.util.type(value))
            return (function stringifyAll(values, language) {
              ...
              for (; ++index < length; ) (value = result[index]), (result[index] = refract.Token.stringify(value, language, result));
              return result;
            })(value, language);
          (env = {
            type: value.type,
        ...
        return function SyntaxHighlighter(_ref7) {
          var language = _ref7.language,
            ...
            rest = (function _objectWithoutProperties(source, excluded) {
              ...
              var key,
                i,
                target = Object(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.l)(source, excluded);
          ...
          ((void 0 === wrapLines && renderer) || wrapLongLines) && (wrapLines = !0), (renderer = renderer || defaultRenderer);
          ...
          return (
            (codeTagProps.style = _objectSpread({}, codeTagProps.style, wrapLongLines ? { whiteSpace: 'pre-wrap' } : { whiteSpace: 'pre' })),
      ...
      var ReactSyntaxHighlighter = SyntaxHighlighter$1,
        navigator = _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.bb.navigator,
        document$1 = _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.bb.document,
        globalWindow = _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.bb.window;
      ...
      function createCopyToClipboardFunction() {
        ...
        return (null == navigator ? void 0 : navigator.clipboard)
          ...
          : function (text) {
              return Object(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.G)(
                _this,
                void 0,
                void 0,
      ...
      var Wrapper = _storybook_theming__WEBPACK_IMPORTED_MODULE_38__.i.div(
          function (_ref10) {
            return { position: 'relative', overflow: 'hidden', color: _ref10.theme.color.defaultText };
          },
          function (_ref11) {
            var theme = _ref11.theme;
            return _ref11.bordered ? { border: '1px solid '.concat(theme.appBorderColor), borderRadius: theme.borderRadius, background: theme.background.content } : {};
          },
        ),
        Scroller = Object(_storybook_theming__WEBPACK_IMPORTED_MODULE_38__.i)(function (_ref12) {
        ...
        Pre = _storybook_theming__WEBPACK_IMPORTED_MODULE_38__.i.pre(function (_ref14) {
          var theme = _ref14.theme;
          return { display: 'flex', justifyContent: 'flex-start', margin: 0, padding: _ref14.padded ? theme.layoutMargin : 0 };
        }),
        Code = _storybook_theming__WEBPACK_IMPORTED_MODULE_38__.i.div(function (_ref15) {
        ...
        SyntaxHighlighter = function SyntaxHighlighter(_a) {
          var children = _a.children,
            ...
            rest = Object(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.I)(_a, [
              'children',
              'language',
              'copyable',
              'bordered',
          ...
          return react__WEBPACK_IMPORTED_MODULE_36___default.a.createElement(
            ...
            copyable
              ? react__WEBPACK_IMPORTED_MODULE_36___default.a.createElement(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.a, {
...
//# sourceMappingURL=1.4e969a66.iframe.bundle.js.map
