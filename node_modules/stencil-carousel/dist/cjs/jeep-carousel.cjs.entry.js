...
const core = require('./core-f2650c2b.js');
...
const JeepCarousel = class {
    constructor(hostRef) {
        ...
        this.didLoad = core.createEvent(this, "jeepCarouselDidLoad", 7);
        this.beforeDestroy = core.createEvent(this, "jeepCarouselBeforeDestroy", 7);
        this.afterDestroy = core.createEvent(this, "jeepCarouselAfterDestroy", 7);
        this.tap = core.createEvent(this, "jeepCarouselTap", 7);
        this.doubleTap = core.createEvent(this, "jeepCarouselDoubleTap", 7);
        this.slideChange = core.createEvent(this, "jeepCarouselSlideChange", 7);
        this.willChange = core.createEvent(this, "jeepCarouselWillChange", 7);
        this.didChange = core.createEvent(this, "jeepCarouselDidChange", 7);
        this.nextStart = core.createEvent(this, "jeepCarouselNextStart", 7);
        this.prevStart = core.createEvent(this, "jeepCarouselPrevStart", 7);
        this.nextEnd = core.createEvent(this, "jeepCarouselNextEnd", 7);
        this.prevEnd = core.createEvent(this, "jeepCarouselPrevEnd", 7);
        this.transitionStart = core.createEvent(this, "jeepCarouselTransitionStart", 7);
        this.transitionEnd = core.createEvent(this, "jeepCarouselTransitionEnd", 7);
        this.drag = core.createEvent(this, "jeepCarouselDrag", 7);
        this.reachStart = core.createEvent(this, "jeepCarouselReachStart", 7);
        this.reachEnd = core.createEvent(this, "jeepCarouselReachEnd", 7);
        this.touchStart = core.createEvent(this, "jeepCarouselTouchStart", 7);
        this.touchEnd = core.createEvent(this, "jeepCarouselTouchEnd", 7);
    }
    ...
    async _setSwiper() {
        const { Swiper } = await new Promise(function (resolve) { resolve(require('./swiper-2accc153.js')); });
        /**
    ...
    render() {
        if (this.innerData && this.innerData.length > 0) {
            ...
            if (this._parallax) {
                if (this.innerParallaxOptions.dataSwiperParallax) {
                    swiperContent = [...swiperContent,
                        core.h("div", { class: "parallax-bg", style: this._parallaxStyle, "data-swiper-parallax": this.innerParallaxOptions.dataSwiperParallax })];
                }
                if (this.innerParallaxOptions.dataSwiperParallaxX && this.innerParallaxOptions.dataSwiperParallaxY) {
                    swiperContent = [...swiperContent,
                        core.h("div", { class: "parallax-bg", style: this._parallaxStyle, "data-swiper-parallax-x": this.innerParallaxOptions.dataSwiperParallaxX, "data-swiper-parallax-y": this.innerParallaxOptions.dataSwiperParallaxY })];
                }
                else if (this.innerParallaxOptions.dataSwiperParallaxX) {
                    swiperContent = [...swiperContent,
                        core.h("div", { class: "parallax-bg", style: this._parallaxStyle, "data-swiper-parallax-x": this.innerParallaxOptions.dataSwiperParallaxX })];
                }
                else if (this.innerParallaxOptions.dataSwiperParallaxY) {
                    swiperContent = [...swiperContent,
                        core.h("div", { class: "parallax-bg", style: this._parallaxStyle, "data-swiper-parallax-y": this.innerParallaxOptions.dataSwiperParallaxY })];
                }
            }
            // add swiper-wrapper
            swiperContent = [...swiperContent,
                core.h("div", { class: "swiper-wrapper" })
            ];
            // add swiper-scrollbar if any
            if (!this.innerPlayControls && this._scrollbar) {
                swiperContent = [...swiperContent,
                    core.h("div", { class: "swiper-scrollbar" })];
            }
            // add swiper-pagination if any
            if (!this.innerPlayControls && this._pagination) {
                swiperContent = [...swiperContent,
                    core.h("div", { class: "swiper-pagination" })];
            }
            // add swiper-navigation-buttons id any
            if (!this.innerPlayControls && this._navigation) {
                swiperContent = [...swiperContent,
                    core.h("div", { class: "swiper-navigation-buttons" }, core.h("div", { class: "swiper-button-prev" }), core.h("div", { class: "swiper-button-next" }))];
            }
            // add swiper-playcontrols-buttons if any
            if (this.innerPlayControls) {
                swiperContent = [...swiperContent,
                    core.h("div", { class: "swiper-playcontrols-buttons" }, this.backward
                        ? core.h("div", { class: "swiper-playcontrols-button autoplay-button-skip-backward", onClick: (event) => this._handleClick(event) })
                        : null, this.pause
                        ? core.h("div", { class: "swiper-playcontrols-button autoplay-button-pause", onClick: (event) => this._handleClick(event) })
                        : core.h("div", { class: "swiper-playcontrols-button autoplay-button-play", onClick: (event) => this._handleClick(event) }), this.forward
                        ? core.h("div", { class: "swiper-playcontrols-button autoplay-button-skip-forward", onClick: (event) => this._handleClick(event) })
                        : null)];
            }
            ...
            return [
                core.h("style", null, this.innerStyle),
                core.h("div", { class: "container" }, this.innerRtl
                    ? core.h("div", { class: "swiper-container", dir: 'rtl' }, swiperContent)
                    : core.h("div", { class: "swiper-container" }, swiperContent), this._thumbs
                    ?
                        core.h("div", { class: "swiper-container " + this._thumbsClass + " gallery-thumbs" }, swiperThumbsContent)
                    :
                        null)
            ];
        }
...
exports.jeep_carousel = JeepCarousel;
