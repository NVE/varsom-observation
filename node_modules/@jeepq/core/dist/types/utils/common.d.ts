...
export declare const getCssPropertyFromString: (cstyle: string, type?: string) => Promise<any>;
export declare const evaluateString: (s: string) => number;
export declare const getBoundingClientRect: (el: Element | HTMLElement, delay: number) => Promise<ClientRect>;
