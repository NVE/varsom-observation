...
import { createSVGElement, createText, updateText, createLine, updateLine, createRect, updateRect, createAnimation, createColumnLabel, removeChilds, textScale, axisRange, axisConvertY } from '../../utils/chart-svgelements';
...
export class JeepColumnchart {
    ...
    render() {
        ...
        if (this.status.status === 200) {
            ...
            toRender = [...toRender,
                h("div", { id: "div-columnchart-container" },
                    h("div", { id: "div-columnchart-chart" },
                        h("svg", { id: "svg-columnchart", width: this.w_width.toString(), height: this.w_height.toString(), viewBox: viewBox },
            ...
            toRender = [...toRender,
                h("div", { id: "div-error-message" },
                    h("p", { id: "p-error-message" }, this.status.message))
            ];
        }
        return (h(Host, null, toRender));
    }
    static get is() { return "jeep-columnchart"; }
    static get encapsulation() { return "shadow"; }
    static get originalStyleUrls() { return {
        "$": ["jeep-columnchart.css"]
    }; }
        ...
        "getCssProperties": {
            "complexType": {
                ...
                "references": {
                    ...
                    "Variables": {
                        "location": "import",
                        "path": "../../global/interfaces/jeep-columnchart"
                    }
                },
    ...
    static get watchers() { return [{
            ...
            "propName": "datapoints",
            "methodName": "parseDatapointsProp"
        }, {
            "propName": "cstyle",
