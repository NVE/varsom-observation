...
import { createSVGElement, createMarker, createText, updateText, textScale, checkDataSetsValidity, createLine, updateLine, axisRange, axisConvertY, measureLegend, createLegendLines, removeChilds, axisConvertX, createPolyline, updatePolyline, createCircle, updateCircle, createAnimation, getTotalLength, createLineLabel, getNearest } from '../../utils/chart-svgelements';
...
export class JeepLinechart {
    ...
    static get events() { return [{
            "method": "readyLinechart",
            "name": "jeepLinechartReady",
            "bubbles": true,
            "cancelable": true,
            "composed": true,
            "docs": {
