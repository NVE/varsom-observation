...
export const createCircle = (g, pos, radius, options) => {
    let opt = getSVGOptions(options);
...
export const updateCircle = (svg, id, pos, radius) => {
...
export function createColumnLabel(svg, colbb, label, index, color, pt, borderBB, options) {
    let opt = getSVGOptions(options);
...
export const axisRange = (arr, axis, _interval, _zero) => {
...
*/
export const checkDataSetsValidity = (arr, axisType) => {
