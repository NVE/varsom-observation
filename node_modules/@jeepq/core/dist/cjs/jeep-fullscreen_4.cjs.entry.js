...
const JeepFullscreen = class {
    constructor(hostRef) {
        ...
        this.onFullscreenRequest = core.createEvent(this, "jeepFullscreenRequest", 7);
        this.onFullscreenExit = core.createEvent(this, "jeepFullscreenExit", 7);
        this.onFullscreenChange = core.createEvent(this, "jeepFullscreenChange", 7);
    }
    //*******************************
    ...
    render() {
        ...
        return (core.h(core.Host, null, core.h("div", { class: "fullscreen-container" }, !this.fullscreen
            ? core.h("div", { class: "fullscreen-button request" })
            : core.h("div", { class: "fullscreen-button exit" }))));
    }
...
const JeepNavigation = class {
    constructor(hostRef) {
        ...
        this.onNavigationPrev = core.createEvent(this, "jeepNavigationPrev", 7);
        this.onNavigationNext = core.createEvent(this, "jeepNavigationNext", 7);
    }
    //*****************************
    //* Watch on Property Changes *
    //*****************************
    ...
    render() {
        ...
        return (core.h(core.Host, null, core.h("div", { class: "navigation-container" }, this.visibility === "visible"
            ?
                core.h("div", { class: "navigation-wrapper" }, core.h("button", { class: 'navigation-prev icon disabled' }), core.h("button", { class: 'navigation-next icon disabled' }))
            : null)));
    }
    get el() { return core.getElement(this); }
...
const JeepPagination = class {
    constructor(hostRef) {
        ...
        this.nbItems = 0;
        this.activeIndex = 0;
        this.onPaginationIndex = core.createEvent(this, "jeepPaginationIndex", 7);
    }
    //*****************************
    //* Watch on Property Changes *
    //*****************************
    ...
    _setPaginationBullets(nbItems) {
        ...
        for (let i = 0; i < this.innerNDisplay; i++) {
            ...
            bullets = [...bullets,
                core.h("span", { class: appliedClass, onClick: () => this._handleClick(initIndex + i) })];
        }
    ...
    render() {
        ...
        return (core.h(core.Host, null, core.h("div", { class: containerClass }, this.visibility === "visible"
            ?
                core.h("div", { class: "pagination-wrapper" }, paginationBullets)
            : null)));
    }
    get el() { return core.getElement(this); }
    static get watchers() { return {
...
const JeepPlayControls = class {
    constructor(hostRef) {
        ...
        this.onPlayControlsIsBeginning = core.createEvent(this, "jeepPlayControlsIsBeginning", 7);
        this.onPlayControlsIsEnd = core.createEvent(this, "jeepPlayControlsIsEnd", 7);
        this.onPlayControlsCurrentIndex = core.createEvent(this, "jeepPlayControlsCurrentIndex", 7);
        this.onPlayControlsAutoplayStart = core.createEvent(this, "jeepPlayControlsAutoplayStart", 7);
        this.onPlayControlsAutoplayStop = core.createEvent(this, "jeepPlayControlsAutoplayStop", 7);
        this.onPlayControlsAutoplayPause = core.createEvent(this, "jeepPlayControlsAutoplayPause", 7);
        this.onPlayControlsAutoplaySkipBackward = core.createEvent(this, "jeepPlayControlsAutoplaySkipBackward", 7);
        this.onPlayControlsAutoplaySkipForward = core.createEvent(this, "jeepPlayControlsAutoplaySkipForward", 7);
    }
    //*****************************
    //* Watch on Property Changes *
    //*****************************
    ...
    render() {
        this._setSkipButtons();
        return (core.h(core.Host, null, core.h("div", { class: "playcontrols-container" }, core.h("div", { class: "playcontrols-button playcontrols-button-skip-backward disabled", onClick: (event) => this._handleClick(event) }), this.play
            ? core.h("div", { class: "playcontrols-button playcontrols-button-play pause", onClick: (event) => this._handleClick(event) })
            : core.h("div", { class: "playcontrols-button playcontrols-button-play play", onClick: (event) => this._handleClick(event) }), core.h("div", { class: "playcontrols-button playcontrols-button-skip-forward disabled", onClick: (event) => this._handleClick(event) }))));
    }
    get el() { return core.getElement(this); }
    static get watchers() { return {
...
exports.jeep_fullscreen = JeepFullscreen;
exports.jeep_navigation = JeepNavigation;
exports.jeep_pagination = JeepPagination;
exports.jeep_play_controls = JeepPlayControls;
