...
const JeepHtmlToprint = class {
    constructor(hostRef) {
        ...
        this._error = null;
        this.printPage = core.createEvent(this, "jeepHtmlToPrint", 7);
        this.printPageReady = core.createEvent(this, "jeepHtmlToPrintReady", 7);
        this.printPageCompleted = core.createEvent(this, "jeepHtmlToPrintCompleted", 7);
    }
    //*****************************
    ...
    render() {
        ...
        */
        return (core.h(core.Host, null, core.h("div", { id: "error-div" }, "Error: slot name toprint doesn't exist"), core.h("slot", { name: 'toprint' })));
    }
    get el() { return core.getElement(this); }
    static get watchers() { return {
        "slotstyle": ["parseSlotStyleProp"]
    }; }
    static get style() { return ":host{display:block}#error-div{width:100%;height:50px;background-color:#d6a0a0;display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;-ms-flex-pack:center;justify-content:center;font-size:1.3rem;color:#000}"; }
};

exports.jeep_html_toprint = JeepHtmlToprint;
