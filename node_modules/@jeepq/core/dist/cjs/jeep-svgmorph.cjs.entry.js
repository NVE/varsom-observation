...
const JeepSvgmorph = class {
    ...
    render() {
        ...
        if (this.isSVG) {
            toRender = [...toRender,
                core.h("div", { id: "morph-container" }, core.h("div", { id: "morph-svg-container" }, core.h("svg", { id: "morph-svg", width: "500", height: "500", viewBox: "0 0 500 500", xmlns: "http://www.w3.org/2000/svg" }, core.h("path", { id: "initPath" }, core.h("animate", { id: "animPath", begin: "initPath.click" }), this._fillColor.length > 1 && !this._uniqueColor
