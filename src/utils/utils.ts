...
export function generatePlotForIceThickness(
  ...
  for (let i = 0; i < iceThicknessLayers.length; i++) {
    iceThickness.push({
      RegID: regId,
      DtObsTime: null,
      ObsLocationID: obsLocationId,
      LocationName: locationName,
      SnowDepth: snowDepth,
      SlushSnow: slushSnow,
      IceThicknessSum: iceThicknessSum,
      IceHeightBefore: IceHeightBefore,
      IceHeightAfter: IceHeightAfter,
      IceLayerID: null,
      IceLayerTID: iceThicknessLayers[i].IceLayerTID,
      IceLayerName: iceThicknessLayers[i].IceLayerName,
      IceLayerThickness: iceThicknessLayers[i].IceLayerThickness,
    });
  }
