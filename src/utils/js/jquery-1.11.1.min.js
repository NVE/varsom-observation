  ...
  (m.event = {
    ...
    (m.Event = function (a, b) {
      return this instanceof m.Event
        ? (a && a.type
            ? ((this.originalEvent = a), (this.type = a.type), (this.isDefaultPrevented = a.defaultPrevented || (void 0 === a.defaultPrevented && a.returnValue === !1) ? ab : bb))
            : (this.type = a),
          b && m.extend(this, b),
      ...
      html: function (a) {
        return V(
          ...
          function (a) {
            ...
            if (
              !('string' != typeof a || mb.test(a) || (!k.htmlSerialize && gb.test(a)) || (!k.leadingWhitespace && hb.test(a)) || rb[(jb.exec(a) || ['', ''])[1].toLowerCase()])
            ) {
              a = a.replace(ib, '<$1></$2>');
              try {
  ...
  m.ajaxSetup({
    ...
    m.ajaxPrefilter('json jsonp', function (b, c, d) {
      var e,
        ...
        h =
          b.jsonp !== !1 &&
          (ad.test(b.url) ? 'url' : 'string' == typeof b.data && !(b.contentType || '').indexOf('application/x-www-form-urlencoded') && ad.test(b.data) && 'data');
