      ...
      <span class="icons-container">
        ...
        {this.ExposedHeight1 && !this.ExposedHeight2 ? (
          <span class="avalanche-height-container">
            <img src={`src/assets/svg/avalanche/Icon-Avalanche-height.svg`}></img>
            <span>{this.ExposedHeight1 + 'm'}</span>
          </span>
        ) : (
          ''
        )}
        ...
        {this.ExposedHeight1 && this.ExposedHeight2 ? (
          <span class="avalanche-height2-container">
            <img src={`src/assets/svg/avalanche/Icon-Avalanche-height2.svg`}></img>
            <span class="avalanche-height-number-container">
