...
export class VarsomMetadata {
  ...
  render(){
    return <div> 
      ...
      <span>
        <img alt='calendar icon' class="image" src={getAssetPath(`/assets/icons/calendar-icon.svg`)}></img>
      ...
      {this.geoHazardName ? 
      <span>
      <img alt='geohazard icon'class="image" src={getAssetPath(`/assets/icons/${getIconName(this.geoHazardName)}-icon.svg`)}></img>
      {this.geoHazardName}
      </span> : ""}
      ...
      {this.nickname ? 
      <span>
        <img alt='user icon' class="image" src={getAssetPath(`/assets/icons/user-icon.svg`)}></img>
      {this.nickname}
      </span> : ""}

      {this.competenceLevelName === "*" ? 
      <span>
        <img alt='rating star icon' src={getAssetPath(`/assets/icons/star-icon-dark.svg`)}></img>
        <img alt='rating star icon' src={getAssetPath(`/assets/icons/star-icon.svg`)}></img>
        <img alt='rating star icon' src={getAssetPath(`/assets/icons/star-icon.svg`)}></img>
        <img alt='rating star icon' class="dark" src={getAssetPath(`/assets/icons/star-icon.svg`)}></img>
        <img alt='rating star icon' class="dark" src={getAssetPath(`/assets/icons/star-icon.svg`)}></img>
      </span> : ""}
      ...
      <span>
      <img alt='user group icon' class="image" src={getAssetPath(`/assets/icons/user-group-icon.svg`)}></img>
