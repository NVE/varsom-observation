...
export class VarsomIncident {
  ...
  render() {
    return (
      <div class="container">
        <varsom-label label={this.strings ? this.strings.Observations.Incident.ObsName : 'Ulykke / Hendelse'}></varsom-label>
        ...
        <div class="content">
          ...
          {this.LocalTouristName ? <varsom-key-value _key={this.shortVersion ? null : 'Local or tourist'} _value={this.LocalTouristName}></varsom-key-value> : ''}

          {this.LocalKnowledgeName ? <varsom-key-value _key={this.shortVersion ? null : 'Local knowledge'} _value={this.LocalKnowledgeName}></varsom-key-value> : ''}

          {this.SafetyGearName ? <varsom-key-value _key={this.shortVersion ? null : 'Safety gear'} _value={this.SafetyGearName}></varsom-key-value> : ''}

          {this.RescueName ? <varsom-key-value _key={this.shortVersion ? null : 'Rescue'} _value={this.RescueName}></varsom-key-value> : ''}

          {this.SlopeActivityName ? <varsom-key-value _key={this.shortVersion ? null : 'Slope activity'} _value={this.SlopeActivityName}></varsom-key-value> : ''}

          {this.TrafficObstructed ? <varsom-key-value _key={this.shortVersion ? null : 'Obsctruction of traffic'} _value={this.TrafficObstructed}></varsom-key-value> : ''}

          {this.MaterialDamages ? <varsom-key-value _key={this.shortVersion ? null : 'Material damage'} _value={this.MaterialDamages}></varsom-key-value> : ''}

          {this.InvolvedNum ? <varsom-key-value _key={this.shortVersion ? null : 'Number involved'} _value={this.InvolvedNum}></varsom-key-value> : ''}

          {this.HarmedNum ? <varsom-key-value _key={this.shortVersion ? null : 'Number injured'} _value={this.HarmedNum}></varsom-key-value> : ''}

          {this.DeadNum ? <varsom-key-value _key={this.shortVersion ? null : 'Number dead'} _value={this.DeadNum}></varsom-key-value> : ''}

          {this.EvacuatedNum ? <varsom-key-value _key={this.shortVersion ? null : 'Number evacuated'} _value={this.EvacuatedNum}></varsom-key-value> : ''}
