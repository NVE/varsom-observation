...
export class VarsomSnowDensity {
  ...
  render() {
    return (
      <div>
        {this.CylinderDiameter ? <varsom-key-value _key={this.strings.Observations.Density.CylinderBoreDiam} _value={this.CylinderDiameter}></varsom-key-value> : ''}

        {this.TareWeight ? <varsom-key-value _key={this.strings.Observations.Density.TareWeight} _value={this.TareWeight}></varsom-key-value> : ''}

        <br></br>
        {this.Comment ? <varsom-key-value _key={this.strings.Observations.SnowProfile.Comment} _value={this.Comment}></varsom-key-value> : ''}

        {this.Layers ? <label>{this.strings.Observations.SnowProfile.SnowDensity}:</label> : ''}
