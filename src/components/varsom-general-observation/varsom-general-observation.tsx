...
export class VarsomGeneralObservation {
  ...
  render() {
    return (
      <div>
        <varsom-label label={this.strings.Observations.GeneralObservation.Notes}></varsom-label>

        <div class="content">
          <varsom-label-small label={this.ObsHeader ? this.ObsHeader : ''}></varsom-label-small>

          {this.ObsComment ? <varsom-key-value _key={this.strings.Observations.GeneralObservation.Comment} _value={this.ObsComment}></varsom-key-value> : ''}
