...
import { Attachment, LatLng } from '../../models/observation-model';
...
export class VarsomDamageObs {
  ...
  render() {
    return (
      <div>
        <varsom-label label={this.strings.Observations.DamageObs.ObsName}></varsom-label>

        <div class="content">
          {this.DamageTypeName ? <varsom-key-value _key={this.strings.Observations.DamageObs.DamageTypeTID} _value={this.DamageTypeName}></varsom-key-value> : ''}

          <br></br>

          {this.Comment ? <varsom-key-value _key={this.strings.Observations.DamageObs.Comment} _value={this.Comment}></varsom-key-value> : ''}
        </div>
