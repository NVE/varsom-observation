...
export class VarsomWaterLevel2 {
  ...
  render() {
    return (
      <div class="container">
        <varsom-label label={this.strings ? this.strings.Observations.WaterLevel.ObsName : 'Vannstand'}></varsom-label>
        ...
        <div class="content">
          ...
          {this.MeasurementReferenceTID ? (
            <varsom-key-value
              ...
              _value={this.MarkingReferenceName + (this.strings ? this.strings.Observations.WaterLevel2.With : ' med ') + (this.MarkingTypeName ? this.MarkingTypeName : '')}
            ></varsom-key-value>
          ) : (
            ''
          )}
