...
export class VarsomObservation {
  ...
  showSlides(n: number, observation: Observation) {
    ...
    if (slides[this.slideIndex - 1] != null) slides[this.slideIndex - 1].style.display = 'block';
    if (slides[this.slideIndex] != null) slides[this.slideIndex].style.display = 'block';
  }
  ...
  async componentWillLoad() {
    ...
    if (!this.json) {
      ...
      } else _data = `{"NumberOfRecords": ${this.count}, "SelectedGeoHazards": [${geoHazardId}], "LangKey": ${langKey}}`;
    ...
    for (let i = 0; i < this.count; i++) {
      ...
      for (let k = 0; k < this.observations.length; k++) {
        ...
        this.observations[k]._snowSurfaceObservation && !this.observations[k]._snowSurfaceObservation.Attachments
          ? (this.observations[k]._snowSurfaceObservation.Attachments = [])
          : '';
        ...
        if (data[i]['Attachments'][j] && data[i]['Attachments'][j] !== 0) {
          ...
          if (data[i]['Attachments'][j].RegistrationTID == 51) {
            if (this.observations[i]._iceCoverObs)
              this.addAttachments(
                ...
                data[i]['Attachments'][j]['Url'],
                data[i]['Attachments'][j]['Comment'],
                data[i]['Attachments'][j]['Photographer'],
                data[i]['Attachments'][j]['Copyright'],
              );
            else
              this.addAttachments(
                this.observations[i],
          ...
          if (data[i]['Attachments'][j].RegistrationTID == 50) {
            if (this.observations[i]._iceThickness)
              this.addAttachments(
                this.observations[i]._iceThickness,
                data[i]['Attachments'][j]['Url'],
                data[i]['Attachments'][j]['Comment'],
                data[i]['Attachments'][j]['Photographer'],
                data[i]['Attachments'][j]['Copyright'],
          ...
          if (data[i]['Attachments'][j].RegistrationTID == 34) {
            if (this.observations[i]._snowProfile2)
              this.addAttachments(
                this.observations[i]._snowProfile2,
                data[i]['Attachments'][j]['Url'],
                data[i]['Attachments'][j]['Comment'],
                data[i]['Attachments'][j]['Photographer'],
                data[i]['Attachments'][j]['Copyright'],
          ...
          if (data[i]['Attachments'][j].RegistrationTID == 22) {
            if (this.observations[i]._snowSurfaceObservation)
              this.addAttachments(
                this.observations[i]._snowSurfaceObservation,
                data[i]['Attachments'][j]['Url'],
                data[i]['Attachments'][j]['Comment'],
                data[i]['Attachments'][j]['Photographer'],
                data[i]['Attachments'][j]['Copyright'],
          ...
          if (data[i]['Attachments'][j].RegistrationTID == 23) {
            if (this.observations[i]._snowCoverObs)
              this.addAttachments(
                this.observations[i]._snowCoverObs,
                data[i]['Attachments'][j]['Url'],
                data[i]['Attachments'][j]['Comment'],
                data[i]['Attachments'][j]['Photographer'],
                data[i]['Attachments'][j]['Copyright'],
          ...
          if (data[i]['Attachments'][j].RegistrationTID == 62) {
            if (this.observations[i]._waterLevel2)
              this.addAttachments(
                this.observations[i]._waterLevel2,
                data[i]['Attachments'][j]['Url'],
                data[i]['Attachments'][j]['Comment'],
                data[i]['Attachments'][j]['Photographer'],
                data[i]['Attachments'][j]['Copyright'],
          ...
          if (data[i]['Attachments'][j].RegistrationTID == 71) {
            if (this.observations[i]._landslideObs)
              this.addAttachments(
                this.observations[i]._landslideObs,
                data[i]['Attachments'][j]['Url'],
                data[i]['Attachments'][j]['Comment'],
                data[i]['Attachments'][j]['Photographer'],
                data[i]['Attachments'][j]['Copyright'],
          ...
          if (data[i]['Attachments'][j].RegistrationTID == 10) {
            if (this.observations[i]._generalObservation)
              this.addAttachments(
                this.observations[i]._generalObservation,
                data[i]['Attachments'][j]['Url'],
                data[i]['Attachments'][j]['Comment'],
                data[i]['Attachments'][j]['Photographer'],
                data[i]['Attachments'][j]['Copyright'],
          ...
          if (data[i]['Attachments'][j].RegistrationTID == 27) {
            if (this.observations[i]._avalancheActivityObs)
              this.addAttachments(
                this.observations[i]._avalancheActivityObs,
                data[i]['Attachments'][j]['Url'],
                data[i]['Attachments'][j]['Comment'],
                data[i]['Attachments'][j]['Photographer'],
                data[i]['Attachments'][j]['Copyright'],
          ...
          if (data[i]['Attachments'][j].RegistrationTID == 30) {
            if (this.observations[i]._avalancheEvaluation2)
              this.addAttachments(
                this.observations[i]._avalancheEvaluation2,
                data[i]['Attachments'][j]['Url'],
                data[i]['Attachments'][j]['Comment'],
                data[i]['Attachments'][j]['Photographer'],
                data[i]['Attachments'][j]['Copyright'],
          ...
          if (data[i]['Attachments'][j].RegistrationTID == 31) {
            if (this.observations[i]._avalancheEvaluation3)
              this.addAttachments(
                this.observations[i]._avalancheEvaluation3,
                data[i]['Attachments'][j]['Url'],
                data[i]['Attachments'][j]['Comment'],
                data[i]['Attachments'][j]['Photographer'],
                data[i]['Attachments'][j]['Copyright'],
          ...
          if (data[i]['Attachments'][j].RegistrationTID == 28) {
            if (this.observations[i]._avalancheEvaluation)
              this.addAttachments(
                this.observations[i]._avalancheEvaluation,
                data[i]['Attachments'][j]['Url'],
                data[i]['Attachments'][j]['Comment'],
                data[i]['Attachments'][j]['Photographer'],
                data[i]['Attachments'][j]['Copyright'],
          ...
          if (data[i]['Attachments'][j].RegistrationTID == 26) {
            if (this.observations[i]._avalancheObs)
              this.addAttachments(
                this.observations[i]._avalancheObs,
                data[i]['Attachments'][j]['Url'],
                data[i]['Attachments'][j]['Comment'],
                data[i]['Attachments'][j]['Photographer'],
                data[i]['Attachments'][j]['Copyright'],
          ...
          if (data[i]['Attachments'][j].RegistrationTID == 61) {
            if (this.observations[i]._waterLevel)
              this.addAttachments(
                this.observations[i]._waterLevel,
                data[i]['Attachments'][j]['Url'],
                data[i]['Attachments'][j]['Comment'],
                data[i]['Attachments'][j]['Photographer'],
                data[i]['Attachments'][j]['Copyright'],
          ...
          if (data[i]['Attachments'][j].RegistrationTID == 13) {
            if (this.observations[i]._dangerObs.length > 0)
              this.addAttachments(
                this.observations[i]._dangerObs[0],
                data[i]['Attachments'][j]['Url'],
                data[i]['Attachments'][j]['Comment'],
                data[i]['Attachments'][j]['Photographer'],
                data[i]['Attachments'][j]['Copyright'],
          ...
          if (data[i]['Attachments'][j].RegistrationTID == 25) {
            if (this.observations[i]._compressionTest.length > 0)
              this.addAttachments(
                this.observations[i]._compressionTest[0],
                data[i]['Attachments'][j]['Url'],
                data[i]['Attachments'][j]['Comment'],
                data[i]['Attachments'][j]['Photographer'],
                data[i]['Attachments'][j]['Copyright'],
          ...
          if (data[i]['Attachments'][j].RegistrationTID == 32) {
            if (this.observations[i]._avalancheEvalProblem2.length > 0)
              this.addAttachments(
                this.observations[i]._avalancheEvalProblem2[0],
                data[i]['Attachments'][j]['Url'],
                data[i]['Attachments'][j]['Comment'],
                data[i]['Attachments'][j]['Photographer'],
                data[i]['Attachments'][j]['Copyright'],
          ...
          if (data[i]['Attachments'][j].RegistrationTID == 24) {
            if (this.observations[i]._avalancheDangerObs.length > 0)
              this.addAttachments(
                this.observations[i]._avalancheDangerObs[0],
                data[i]['Attachments'][j]['Url'],
                data[i]['Attachments'][j]['Comment'],
                data[i]['Attachments'][j]['Photographer'],
                data[i]['Attachments'][j]['Copyright'],
          ...
          if (data[i]['Attachments'][j].RegistrationTID == 33) {
            if (this.observations[i]._avalancheActivityObs2.length > 0)
              this.addAttachments(
                this.observations[i]._avalancheActivityObs2[0],
                data[i]['Attachments'][j]['Url'],
                data[i]['Attachments'][j]['Comment'],
                data[i]['Attachments'][j]['Photographer'],
                data[i]['Attachments'][j]['Copyright'],
          ...
          if (data[i]['Attachments'][j].RegistrationTID == 14) {
            if (this.observations[i]._damageObs.length > 0)
              this.addAttachments(
                this.observations[i]._damageObs[0],
                data[i]['Attachments'][j]['Url'],
                data[i]['Attachments'][j]['Comment'],
                data[i]['Attachments'][j]['Photographer'],
                data[i]['Attachments'][j]['Copyright'],
      ...
      for (let m = 0; m < data[i]['Attachments'].length; m++) {
        ...
        if (m == 0 || m % 2 == 0) this.observations[i]._loopNumbers.push(m);
      }
    }
  }
...
></varsom-static-map>
              ...
              <div class="container-for-image-slider">
                {navigator.userAgent.match(/Android/i) || navigator.userAgent.match(/iPhone/i) ? (
                  <varsom-image-slider-mobile _images={obs._images} shortVersion={this.version === 'short' ? this.version : null} observation={obs}></varsom-image-slider-mobile>
                ) : (
                  <varsom-image-slider _images={obs._images} shortVersion={this.version === 'short' ? this.version : null} observation={obs}></varsom-image-slider>
                )}
              </div>
            )}
            {/* CONTENT */}
            <div class="observation-content">
              ...
              {obs._damageObs.length > 0 ? <div class="border"></div> : ''}
              ...
              {obs._avalancheDangerObs.length > 0 ? (
                <varsom-label label={this.strings.Observations.AvalancheDangerObs.ObsName ? this.strings.Observations.AvalancheDangerObs.ObsName : 'Faretegn'}></varsom-label>
              ) : (
                ''
              )}
              ...
              {obs._avalancheActivityObs2.length > 0 ? <div class="border"></div> : ''}
              ...
              {obs._avalancheEvalProblem2.length > 0 ? <div class="border"></div> : ''}
              ...
              {/* LINK TO REGOBS */}
              <varsom-regobs-link regId={obs._regId}></varsom-regobs-link>
            </div>
          </div>
        ))}
      </div>
