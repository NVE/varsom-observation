...
*/}
                      ...
                      <img
                        ...
                        onClick={() => (this.modal[num].style.display = 'block')}
                      ></img>
                    </figure>
                    ...
                    <div tabIndex={0} ref={mod => (this.modal[num] = mod as HTMLElement)} class="modal">
                      <div class="modal-content">
                        <span class="close" ref={close => (this.closeBtn[num] = close as HTMLElement)} onClick={() => (this.modal[num].style.display = 'none')}>
                          &times;
                        </span>
                        <figure>
                    ...
                    {this._images.length > num + 1 ? (
                      <div tabIndex={0} ref={mod => (this.modal[num + 1] = mod as HTMLElement)} class="modal">
                        <div class="modal-content">
                          <span class="close" ref={close => (this.closeBtn[num + 1] = close as HTMLElement)} onClick={() => (this.modal[num + 1].style.display = 'none')}>
                            &times;
                          </span>
                          <figure>
                    ...
                    {this._images.length > num + 1 ? (
                      <figure tabIndex={0}>
                        <img
                          alt={this._images[num]._comment ? this._images[num]._comment : 'observation image'}
                          class="observation-images"
                          src={this._images[num + 1]._imageData}
                  ...
                  {this._images.length > 2 ? (
                    <div>
                      <a tabIndex={0} class="prev" onClick={this.plusSlides.bind(this, -2)}>
                        &#10094;
                      </a>
                      <a tabIndex={0} class="next" onClick={this.plusSlides.bind(this, 2)}>
                        &#10095;
                      </a>
                    </div>
                  ) : null}
