      ...
      <div class="images-container">
        <figure>
          ...
          <figcaption class={this.CropImage ? 'smallImageInfo' : 'imageInfo'}>
            {this.Copyright ? <varsom-key-value _key={this.strings.Observations.Picture.Copyright} _value={this.Copyright}></varsom-key-value> : null}

            <br></br>
            {this.Photographer ? <varsom-key-value _key={this.strings.Observations.Picture.Photographer} _value={this.Photographer}></varsom-key-value> : null}

            <br></br>
            {this.Comment ? <varsom-key-value _key={this.strings.Observations.Picture.PictureComment} _value={this.Comment}></varsom-key-value> : null}
          </figcaption>
        </figure>
        ...
        <div ref={mod => (this.modal = mod as HTMLElement)} class="modal">
          <div class="modal-content">
            ...
            <figure>
              ...
              <figcaption>
                {this.Copyright ? (
                  <varsom-key-value _key={this.strings ? this.strings.Observations.Picture.Copyright : 'Opphavsrett'} _value={this.Copyright}></varsom-key-value>
                ) : null}

                <br></br>
                {this.Photographer ? (
                  <varsom-key-value _key={this.strings ? this.strings.Observations.Picture.Photographer : 'Fotograf'} _value={this.Photographer}></varsom-key-value>
                ) : null}

                <br></br>
                {this.Comment ? (
                  <varsom-key-value _key={this.strings ? this.strings.Observations.Picture.PictureComment : 'Kommentar'} _value={this.Comment}></varsom-key-value>
                ) : null}
              </figcaption>
            </figure>
          </div>
